...
void describeComponent(Component component, UTF8 * description)
{
	...
	case Component::ComponentType::ExchangeRICoordinateSystem:
		*description = *description + "Component Type: RI Coordinate System";
		break;
	...
	case Component::ComponentType::ExchangeTopoSingleWireBody:
		*description = *description + "Component Type: Topo Single Wire Body";
		break;
...
{
	SegmentKey textKey = (reinterpret_cast<CustomEvent const *>(in_event))->textSegmentKey;

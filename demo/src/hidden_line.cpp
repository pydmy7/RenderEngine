...
void Sample::Hidden_Line(WindowKey wk, Canvas canvas, View view, Model model,
                         SegmentKey modelKey) {
    /* Sample: Hidden_Line
     ...
     * 1. Change the visibility for the segment as needed through a
     * VisibilityControl
     * 2. Set the rendering algorithm to HiddenLine from the SubwindowControl
     * 3. Tweak Hidden Line attributes as needed from the

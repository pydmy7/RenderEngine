...
void Sample::Lightweight_Subwindow(WindowKey wk, Canvas canvas, View view,
     ...
     * attributes
     * 2. Apply the camera kit to the segment where the camera needs to be
     * inserted */
    CameraKit camera;
    ...
    /* To make sure that the legend will be displayed on top of the geometry, it
     * is placed in a lightweight window. */
    legendBar.GetSubwindowControl().SetSubwindow(HPS::Rectangle(0, 1, -1, 1),

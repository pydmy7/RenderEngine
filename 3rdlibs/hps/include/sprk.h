...
namespace HPS {
    ...
    struct SPRK_API RGBColorKeyframe {
        /*!	Creates a new RGBColorKeyframe, suitable for using with a RGBSampler object.
         *	The correspondence between real time and ticks can be controlled through AnimationControl::SetTimePerTick
         *	The RGB components of RGBColorKeyframes cannot have values outside the [0 - 1] range.
         *	Setting a keyframe with such a value on a sampler will result in an InvalidSpecificationException being thrown
         *	\param in_ticks The time, specified in ticks, when this keyframe should be executed.
         *	\param in_value The value of this keyframe at the specified time. */
         ...
         *	\param in_that The source RGBColorKeyframe to compare to this RGBColorKeyframe.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
        bool operator!=(RGBColorKeyframe const& in_that) const;

        /*!	Check if the source RGBColorKeyframe is equal to this RGBColorKeyframe.
         *	\param in_that The source RGBColorKeyframe to compare to this RGBColorKeyframe.
         *	\return <span class='code'>true</span> if the objects are equal, <span class='code'>false</span> otherwise. */
        bool operator==(RGBColorKeyframe const& in_that) const;
    ...
    struct SPRK_API RGBColorSplineControlValues {
        /*!	Creates a new RGBColorSplineControlValues object used to desribe control values for an individual RGBColorKeyframe
         *	when interpolating across a series of keyframes in a RGBColorSampler using Spline interpolation.
         *	\param in_input The value subtracted from the associated keyframe value to develop the input tangent.
         *	\param in_output The value from which the associated keyframe value is subtracted to develop the output tangent. */
         ...
         *	\param in_that The source RGBColorSplineControlValues to compare to this RGBColorSplineControlValues.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    struct SPRK_API VectorKeyframe {
        /*!	Creates a new VectorKeyframe, suitable for using with a VectorSampler object.
         *	The correspondence between real time and ticks can be controlled through AnimationControl::SetTimePerTick
         *	\param in_ticks The time, specified in ticks, when this keyframe should be executed.
         *	\param in_value The value of this keyframe at the specified time. */
         ...
         *	\param in_that The source VectorKeyframe to compare to this VectorKeyframe.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    struct SPRK_API VectorSplineControlValues {
        /*!	Creates a new VectorSplineControlValues object used to desribe control values for an individual VectorKeyframe
         *	when interpolating across a series of keyframes in a VectorSampler using Spline interpolation.
         *	\param in_input The value subtracted from the associated keyframe value to develop the input tangent.
         *	\param in_output The value from which the associated keyframe value is subtracted to develop the output tangent. */
         ...
         *	\param in_that The source VectorSplineControlValues to compare to this VectorSplineControlValues.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    struct SPRK_API PointKeyframe {
        /*!	Creates a new PointKeyframe, suitable for using with a PointSampler object.
         *	The correspondence between real time and ticks can be controlled through AnimationControl::SetTimePerTick
         *	\param in_ticks The time, specified in ticks, when this keyframe should be executed.
         *	\param in_value The value of this keyframe at the specified time. */
         ...
         *	\param in_that The source PointKeyframe to compare to this PointKeyframe.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    struct SPRK_API PointSplineControlValues {
        /*!	Creates a new PointSplineControlValues object used to describe control values for an individual PointKeyframe
         *	when interpolating across a series of keyframes in a PointSampler using Spline interpolation.
         *	\param in_input The value subtracted from the associated keyframe value to develop the input tangent.
         *	\param in_output The value from which the associated keyframe value is subtracted to develop the output tangent. */
        PointSplineControlValues(Point const& in_input, Point const& in_output);

        /*!	Check if the source PointSplineControlValues is different from this PointSplineControlValues.
         *	\param in_that The source PointSplineControlValues to compare to this PointSplineControlValues.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
        bool operator!=(PointSplineControlValues const& in_that) const;
    ...
    struct SPRK_API QuaternionKeyframe {
        /*!	Creates a new QuaternionKeyframe, suitable for using with a QuaternionSampler object.
         *	The correspondence between real time and ticks can be controlled through AnimationControl::SetTimePerTick
         *	\param in_ticks The time, specified in ticks, when this keyframe should be executed.
         *	\param in_value The value of this keyframe at the specified time. */
         ...
         *	\param in_that The source QuaternionKeyframe to compare to this QuaternionKeyframe.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    struct SPRK_API QuaternionSplineControlValues {
        /*!	Creates a new QuaternionSplineControlValues object used to desribe control values for an individual QuaternionKeyframe
         *	when interpolating across a series of keyframes in a QuaternionSampler using Spline interpolation.
         *	\param in_input The value subtracted from the associated keyframe value to develop the input tangent.
         *	\param in_output The value from which the associated keyframe value is subtracted to develop the output tangent. */
         ...
         *	\param in_that The source QuaternionSplineControlValues to compare to this QuaternionSplineControlValues.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    struct SPRK_API FloatKeyframe {
        /*!	Creates a new FloatKeyframe, suitable for using with a FloatSampler object.
         *	The correspondence between real time and ticks can be controlled through AnimationControl::SetTimePerTick
         *	\param in_ticks The time, specified in ticks, when this keyframe should be executed.
         *	\param in_value The value of this keyframe at the specified time. */
         ...
         *	\param in_that The source FloatKeyframe to compare to this FloatKeyframe.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    struct SPRK_API FloatSplineControlValues {
        /*!	Creates a new FloatSplineControlValues object used to desribe control values for an individual FloatKeyframe
         *	when interpolating across a series of keyframes in a FloatSampler using Spline interpolation.
         *	\param in_input The value subtracted from the associated keyframe value to develop the input tangent.
         *	\param in_output The value from which the associated keyframe value is subtracted to develop the output tangent. */
         ...
         *	\param in_that The source FloatSplineControlValues to compare to this FloatSplineControlValues.
         *	\return <span class='code'>true</span> if the objects are different, <span class='code'>false</span> otherwise. */
    ...
    enum class SPRK_API ChannelColorUsage {
        Face = 0x00000001, //!< The face color of the target of this Channel will be changed
        Line = 0x00000010, //!< The line color of the target of this Channel will be changed
        Edge = 0x00000100, //!< The edge color of the target of this Channel will be changed
        Marker = 0x00001000, //!< The marker color will be changed
    };
    ...
    typedef std::vector<Sampler, Allocator<Sampler>> SamplerArray;
    typedef std::vector<Channel, Allocator<Channel>> ChannelArray;
    typedef std::vector<Animation, Allocator<Animation>> AnimationArray;
    typedef std::vector<VectorKeyframe, Allocator<VectorKeyframe>> VectorKeyframeArray;
    typedef std::vector<PointKeyframe, Allocator<PointKeyframe>> PointKeyframeArray;
    typedef std::vector<FloatKeyframe, Allocator<FloatKeyframe>> FloatKeyframeArray;
    typedef std::vector<QuaternionKeyframe, Allocator<QuaternionKeyframe>> QuaternionKeyframeArray;
    typedef std::vector<RGBColorKeyframe, Allocator<RGBColorKeyframe>> RGBColorKeyframeArray;

    typedef std::vector<VectorSplineControlValues, Allocator<VectorSplineControlValues>> VectorSplineControlValuesArray;
    typedef std::vector<PointSplineControlValues, Allocator<PointSplineControlValues>> PointSplineControlValuesArray;
    typedef std::vector<FloatSplineControlValues, Allocator<FloatSplineControlValues>> FloatSplineControlValuesArray;
    typedef std::vector<QuaternionSplineControlValues, Allocator<QuaternionSplineControlValues>>
        QuaternionSplineControlValuesArray;
    typedef std::vector<RGBColorSplineControlValues, Allocator<RGBColorSplineControlValues>> RGBColorSplineControlValuesArray;
    typedef std::vector<ChannelColorUsage, Allocator<ChannelColorUsage>>
        ChannelColorUsageArray; //!< Array of type HPS::ChannelColorUsage

    /*@}*/

    /*! Sampler is an abstract class which is contains settings common to all kinds of Samplers.
     * A Sampler is an object that contains a series of Keyframes and which describe how the Animation will interpolate
     * between the values specified in the Keyframes.
     * Objects of the Sampler class should not be instantiated directly, rather, users should created objects of type
     * FloatSampler, VectorSampler, PointSampler or RGBColorSampler, based on the type of data required by the Channel to which
     * the Sampler will be assigned. */
    class SPRK_API Sampler: public Sprocket {
      public:
        ...
        enum class InterpolationType {
            ...
            SphericalLinear, //!< Channel values will interpolated spherical-linearly between keyframes. If this is supplied to
                             //!< FloatSampler a linear interpolation is performed instead.
            Spline //!< Channel values will interpolated between keyframes by computing a spline from control values specified
                   //!< alongside the keyframes.
        };
         ...
         *	\param in_that The Sampler source of the assignment.
         ...
         *	\param in_that The source Sampler to compare to this Sampler.
         *	\return <span class='code'>true</span> if the objects reference the same impl, <span class='code'>false</span>
         *otherwise. */
        bool Equals(Sampler const& in_that) const;

        /*!	Check if the source Sampler points to a different impl than this Sampler.
         *	\param in_that The source Sampler to compare to this Sampler.
         *	\return <span class='code'>true</span> if the objects reference different impls, <span class='code'>false</span>
         *otherwise. */
         ...
         *	\return in_interpolation The interpolation to be used with this Sampler. */
        void SetInterpolation(InterpolationType in_interpolation);

        /*!	Returns the interpolation setting used by this Sampler.
         *	\return in_interpolation the interpolation setting used by this Sampler. */
        InterpolationType GetInterpolation() const;
    };

    /*! A RGBColorSampler is a type of Sampler which holds Keyframe which specify values as RGBColors.
     * For example, if a Channel is setup to animate the color of a target segment, the values assumed by that
     * color will have to be specified as RGBColors, and therefore be held in RGBColorKeyframes, which will be collected
     * in a RGBColorSampler. */
    class SPRK_API RGBColorSampler: public Sampler {
      public:
        static const HPS::Type staticType = HPS::Type::RGBColorSampler;

        HPS::Type ObjectType() const { return staticType; }

        RGBColorSampler();
        explicit RGBColorSampler(Sampler const& in_that);
        RGBColorSampler(RGBColorSampler const& in_that);
        virtual ~RGBColorSampler();

        /*! Replaces the keyframes on this Sampler with those provided
         *	The provided keyframes will be automatically sorted and validated.
         *	Each element in in_keyframe should target a different timer tick.
         *	The RGB components of RGBColorKeyframes cannot have values outside the [0 - 1] range.
         *	Not complying with the restrictions specified above will result in an exception of type
         *HPS::InvalidSpecificationException being thrown. \param in_keyframes the array of keyframes to add to this Sampler */
        void SetKeyframes(RGBColorKeyframeArray const& in_keyframes);
         ...
         *	The RGB components of RGBColorKeyframes cannot have values outside the [0 - 1] range.
         *	Not complying with the restrictions specified above will result in an exception of type
         *HPS::InvalidSpecificationException being thrown. \param in_count the number of keyframes in the in_keyframes array
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void SetKeyframes(size_t in_count, RGBColorKeyframe const in_keyframes[]);

        /*! Adds the provided keyframes to this Sampler.
         *	The provided keyframes will be automatically sorted and validated.
         *	Adding a key frame will replace already existing keyframes that target the same timer tick.
         *	Each element in in_keyframe should target a different timer tick.
         *	The RGB components of RGBColorKeyframes cannot have values outside the [0 - 1] range.
         *	Not complying with the restrictions specified above will result in an exception of type
         *HPS::InvalidSpecificationException being thrown. \param in_keyframes the array of keyframes to add to this Sampler */
        void AddKeyframes(RGBColorKeyframeArray const& in_keyframes);
         ...
         *HPS::InvalidSpecificationException being thrown. \param in_count the number of keyframes in the in_keyframes array
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void AddKeyframes(size_t in_count, RGBColorKeyframe const in_keyframes[]);

        /*! Adds the provided keyframe to this Sampler.
         *	The provided keyframe will be automatically sorted into the Sampler.
         *	If the sampler already contains a keyframe targeting the same timer tick as in_keyframe, it will be replaced
         *	The RGB components of in_keyframe cannot have the values outside of the [0 - 1] range.
         *  Doing so will reuslt in an exception of type HPS::InvalidSpecificationException being thrown.
         *	\param in_keyframe the keyframe to add to this Sampler */
        void AddKeyframe(RGBColorKeyframe const& in_keyframe);

        /*! Returns the keyframes contained in this Sampler.
         *	Because keyframes are sorted as they are added to the Sampler, the order of keyframes returned might not
         *	match the order in which they were inserted in this Sampler.
         *	\return An array of keyframes contained in this Sampler. */
        RGBColorKeyframeArray const& GetKeyframes() const;

        /*! Sets control values used during Spline interpolation of keyframe values.
         *  If this Sampler is not set to use Spline interpolation these values will be ignored during playback.
         *	\param in_control_points The control points to use for interpolation.
         *	When executing playback this array must be equal in size to the keyframe array associated with this Sampler. */
        void SetControlValues(RGBColorSplineControlValuesArray const& in_control_points);

        /*! Returns the control values this Sampler is set to use during Spline interpolation of keyframe values.
         *	\return An array of control point values previously specified to SetControlValues. */
        RGBColorSplineControlValuesArray const& GetControlValues() const;
    };

    /*! A VectorSampler is a type of Sampler which holds Keyframe which specify values as Vectors.
     * For example, if a Channel is setup to animate the value of the camera's up vector, the values assumed by the
     * up vector will have to be specified as Vectors, and therefore be held in VectorKeyframes, which will be collected
     * in a VectorSampler. */
    class SPRK_API VectorSampler: public Sampler {
      public:
        static const HPS::Type staticType = HPS::Type::VectorSampler;

        HPS::Type ObjectType() const { return staticType; }

        VectorSampler();
        explicit VectorSampler(Sampler const& in_that);
        VectorSampler(VectorSampler const& in_that);
        virtual ~VectorSampler();

        /*! Replaces the keyframes on this Sampler with those provided
         *	The provided keyframes will be automatically sorted and validated.
         *	Each element in in_keyframe should target a different timer tick.
         *	Not complying with the restriction specified above will result in an exception of type
         *HPS::InvalidSpecificationException being thrown. \param in_keyframes the array of keyframes to add to this Sampler */
        void SetKeyframes(VectorKeyframeArray const& in_keyframes);
         ...
         *HPS::InvalidSpecificationException being thrown. \param in_count the number of keyframes in the in_keyframes array
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void SetKeyframes(size_t in_count, VectorKeyframe const in_keyframes[]);
         ...
         *	Not complying with the restriction specified above will result in an exception of type
         *HPS::InvalidSpecificationException being thrown. \param in_keyframes the array of keyframes to add to this Sampler */
        void AddKeyframes(VectorKeyframeArray const& in_keyframes);
         ...
         *HPS::InvalidSpecificationException being thrown. \param in_count the number of keyframes in the in_keyframes array
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void AddKeyframes(size_t in_count, VectorKeyframe const in_keyframes[]);

        /*! Adds the provided keyframe to this Sampler.
         *	The provided keyframe will be automatically sorted into the Sampler.
         *	If the sampler already contains a keyframe targeting the same timer tick as in_keyframe, it will be replaced
         *	\param in_keyframe the keyframe to add to this Sampler */
        void AddKeyframe(VectorKeyframe const& in_keyframe);

        /*! Returns the keyframes contained in this Sampler.
         *	Because keyframes are sorted as they are added to the Sampler, the order of keyframes returned might not
         *	match the order in which they were inserted in this Sampler.
         *	\return An array of keyframes contained in this Sampler. */
        VectorKeyframeArray const& GetKeyframes() const;

        /*! Sets control values used during Spline interpolation of keyframe values.
         *  If this Sampler is not set to use Spline interpolation these values will be ignored during playback.
         *	\param in_control_points The control points to use for interpolation.
         *	When executing playback this array must be equal in size to the keyframe array associated with this Sampler. */
        void SetControlValues(VectorSplineControlValuesArray const& in_control_points);

        /*! Returns the control values this Sampler is set to use during Spline interpolation of keyframe values.
         *	\return An array of control point values previously specified to SetControlValues. */
        VectorSplineControlValuesArray const& GetControlValues() const;
    };

    /*! A PointSampler is a type of Sampler which holds Keyframe which specify values as Points.
     * For example, if a Channel is setup to animate the value of the camera's target, the values assumed by the
     * camera target will have to be specified as Points, and therefore be held in PointKeyframes, which will be collected
     * in a PointSampler. */
    class SPRK_API PointSampler: public Sampler {
      public:
        ...
        PointSampler();
        explicit PointSampler(Sampler const& in_that);
        PointSampler(PointSampler const& in_that);
        virtual ~PointSampler();

        /*! Replaces the keyframes on this Sampler with those provided
         *	The provided keyframes will be automatically sorted and validated.
         *	Each element in in_keyframe should target a different timer tick. Not complying will result in
         *	an exception of type HPS::InvalidSpecificationException being thrown.
         *	\param in_keyframes the array of keyframes to add to this Sampler */
         ...
         *	Each element in in_keyframe should target a different timer tick. Not complying will result in
         *	an exception of type HPS::InvalidSpecificationException being thrown.
         *	\param in_count the number of keyframes in the in_keyframes array
         *	\param in_keyframes the array of keyframes to add to this Sampler */
    ...
    /*! A QuaternionSampler is a type of Sampler which holds Keyframe which specify values as Quaternions.
     * For example, if a Channel is setup to animate the value of the camera's target, the values assumed by the
     * camera target will have to be specified as Quaternions, and therefore be held in QuaternionKeyframes, which will be
     * collected in a QuaternionSampler. */
    class SPRK_API QuaternionSampler: public Sampler {
      public:
        static const HPS::Type staticType = HPS::Type::QuaternionSampler;

        HPS::Type ObjectType() const { return staticType; }

        QuaternionSampler();
        explicit QuaternionSampler(Sampler const& in_that);
        QuaternionSampler(QuaternionSampler const& in_that);
        virtual ~QuaternionSampler();
         ...
         *	an exception of type HPS::InvalidSpecificationException being thrown.
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void SetKeyframes(QuaternionKeyframeArray const& in_keyframes);
         ...
         *	\param in_count the number of keyframes in the in_keyframes array
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void SetKeyframes(size_t in_count, QuaternionKeyframe const in_keyframes[]);
         ...
         *	an exception of type HPS::InvalidSpecificationException being thrown.
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void AddKeyframes(QuaternionKeyframeArray const& in_keyframes);
         ...
         *	\param in_count the number of keyframes in the in_keyframes array
         *	\param in_keyframes the array of keyframes to add to this Sampler */
        void AddKeyframes(size_t in_count, QuaternionKeyframe const in_keyframes[]);

        /*! Adds the provided keyframe to this Sampler.
         *	The provided keyframe will be automatically sorted into the Sampler.
         *	If the sampler already contains a keyframe targeting the same timer tick as in_keyframe, it will be replaced
         *	\param in_keyframe the keyframe to add to this Sampler */
        void AddKeyframe(QuaternionKeyframe const& in_keyframe);

        /*! Returns the keyframes contained in this Sampler.
         *	Because keyframes are sorted as they are added to the Sampler, the order of keyframes returned might not
         *	match the order in which they were inserted in this Sampler.
         *	\return An array of keyframes contained in this Sampler. */
        QuaternionKeyframeArray const& GetKeyframes() const;

        /*! Sets control values used during Spline interpolation of keyframe values.
         *  If this Sampler is not set to use Spline interpolation these values will be ignored during playback.
         *	\param in_control_points The control points to use for interpolation.
         *	When executing playback this array must be equal in size to the keyframe array associated with this Sampler. */
        void SetControlValues(QuaternionSplineControlValuesArray const& in_control_points);

        /*! Returns the control values this Sampler is set to use during Spline interpolation of keyframe values.
         *	\return An array of control point values previously specified to SetControlValues. */
        QuaternionSplineControlValuesArray const& GetControlValues() const;
    };

    /*! A FloatSampler is a type of Sampler which holds Keyframe which specify values as floats.
     * For example, if a Channel is setup to animate the target's opacity, the target's alpha channel value
     * will be specified in floats, and therefore be held in FloatKeyframes, which will be collected
     * in a FloatSampler. */
    class SPRK_API FloatSampler: public Sampler {
      public:
    ...
    /*! The Channel class describes part of an Animation through the use of a Sampler.
        A Channel is associated to an Animation, and as such needs to be created through one of the Animation::AddChannel
       functions. Each Channel is specific to a type of animation and targets a specific object in the scene graph. */
    class SPRK_API Channel: public Sprocket {
      public:
        /*! \enum ChannelType
         ...
         *	\param in_that The Channel source of the assignment.
         ...
         *	\param in_that The source Channel to compare to this Animation.
         *	\return <span class='code'>true</span> if the objects reference the same impl, <span class='code'>false</span>
         *otherwise. */
        ...
        /*!	Check if the source Channel points to the same underlying impl as this Channel.
         *	\param in_that The source Channel to compare to this Channel.
         *	\return <span class='code'>true</span> if the objects reference the same impl, <span class='code'>false</span>
         *otherwise. */
        bool operator==(Channel const& in_that) const;

        /*!	Returns the target of this Channel. If this Channel is being used to animate a camera property this key path will be
         *empty. \return The SegmentKey targeted by this Channel */
         ...
         *	\param in_that The source Sampler to use.*/
        void SetSampler(Sampler const& sampler);
    };

    /*! The Animation class is used to animate objects in the scene through the creation of one or more Channels.
        An Animation is owned by a Model, and as such needs to be created through the Model::CreateAnimation function.
        Animation objects are only valid for playback if they contain one or more Channel objects. */
    class SPRK_API Animation: public Sprocket {
      public:
         ...
         *	\param in_that The Animation source of the assignment.
         *	\return A reference to this Animation. */
         ...
         *	\param in_that The source Animation to compare to this Animation.
         *	\return <span class='code'>true</span> if the objects reference the same impl, <span class='code'>false</span>
         *otherwise. */
         ...
         *	\param in_name A name used to identify this Channel.
         *	\param in_target The segment on which the changes described by this Channel will be applied during the Animation
         *playback. \param in_sampler A sampler containing Point keyframes, describing the changes to be applied to in_target over
         *time. \return The Channel that was just added to this Animation. */
         ...
         *	\param in_name A name used to identify this Channel.
         *	\param in_target The segment on which the changes described by this Channel will be applied during the Animation
         *playback. \param in_sampler A sampler containing Vector keyframes, describing the changes to be applied to in_target
         *over time. \return The Channel that was just added to this Animation. */
         ...
         *	\param in_name A name used to identify this Channel.
         *	\param in_target The segment on which the changes described by this Channel will be applied during the Animation
         *playback. \param in_sampler A sampler containing RGBColor keyframes, describing the changes to be applied to in_target
         *	\param in_channel_usages The types of the target of this Channel that will be changed during the Animation.
         *over time. \return The Channel that was just added to this Animation. */
        Channel AddColorChannel(char const* in_name,
                                KeyPath const& in_target,
                                RGBColorSampler const& in_sampler,
                                HPS::ChannelColorUsageArray in_channel_usages);
         ...
         *	\param in_name A name used to identify this Channel.
         *	\param in_target The segment on which the changes described by this Channel will be applied during the Animation
         *playback. \param in_sampler A sampler containing float keyframes, describing the changes to be applied to in_target over
         *time. \return The Channel that was just added to this Animation. */
         ...
         *	\param in_name A name used to identify this Channel.
         *	\param in_sampler A sampler containing Point keyframes, describing the changes to be applied to in_target over time.
         *	\return The Channel that was just added to this Animation. */
         ...
         *	\param in_name A name used to identify this Channel.
         *	\param in_sampler A sampler containing Vector keyframes, describing the changes to be applied to in_target over time.
         *	\return The Channel that was just added to this Animation. */
    ...
    /*! The Canvas class is one of the four core display classes used in a Visualize application. It is meant to be used as part
       of a display hierarchy along with the Layout, View, and Model objects. The Canvas is the top-level object of the hierarchy
       and roughly correlates to a window. The Canvas is backed by an HPS::WindowKey. */
    class SPRK_API Canvas: public Sprocket {
      public:
        ...
        /*! Redraws the entire Canvas, including all of its child components using the default options, and also returns a
         * notifier to facilitate tracking the update progress. \return An UpdateNotifier object used to find out information
         * about the update. */
    ...
    class SPRK_API SprocketControl: public Sprocket {
      ...
      protected:
        ...
        /*! The move constructor creates a SprocketControl by transferring the underlying impl of the rvalue reference to this
         * SprocketControl thereby avoiding a copy and allocation.
        ...
        /*! The move assignment operator transfers the underlying impl of the rvalue reference to this SprocketControl thereby
         * avoiding a copy. \param in_that An rvalue reference to an SprocketControl to take the impl from.
    ...
    class SPRK_API SprocketKit: public Sprocket {
      ...
      protected:
        ...
        /*! The move constructor creates a SprocketKit by transferring the underlying impl of the rvalue reference to this
         * SprocketKit thereby avoiding a copy and allocation. \param in_that An rvalue reference to a SprocketKit to take the
         * impl from.*/
        SprocketKit(SprocketKit&& in_that): Sprocket(std::move(in_that)) {}

        /*! The move assignment operator transfers the underlying impl of the rvalue reference to this SprocketKit thereby
         * avoiding a copy. \param in_that An rvalue reference to an SprocketKit to take the impl from. \return A reference to
         * this SprocketKit. */
    ...
    /*! The View class is one of the four core display classes used in a Visualize application. It is meant to be used as part of
       a display hierarchy along with the Canvas, Layout, and Model objects. The View has a parent Layout and can contain a single
       Model. The View is meant to represent one particular camera's view of the scene. Like the other three core objects, the
       View is backed by a HPS::SegmentKey. */
    class SPRK_API View: public Sprocket {
      public:
        ...
        /*! This method  computes a camera to fit the extents of a segment.
        \param in_segment The segment used to calculate the new camera.
        \param in_transform An optional transform to apply to the segment bounding used to compute the camera.  This can be used
        to ensure that the camera is looking at the geometry in the correct position once any modelling matrices are applied.
        \param out_camera The camera computed by the fit world routine. */
        HPS::View& ComputeFitWorldCamera(SegmentKey const& in_segment, MatrixKit const& in_transform, HPS::CameraKit& out_camera);

        /*! This method computes a camera to fit a bounding.
        \param in_bounding The bounding used to calculate the new camera.
        \param in_transform An optional transform to apply to the bounding used to compute the camera.  This can be used to ensure
        that the camera is looking at the geometry in the correct position once any modelling matrices are applied. \param
        out_camera The camera computed by the fit world routine. */
        HPS::View&
            ComputeFitWorldCamera(BoundingKit const& in_bounding, MatrixKit const& in_transform, HPS::CameraKit& out_camera);
        ...
        * If there might be transforms between in_segment and the View segment, you can use the version of FitWorld which does not
        require a parameter,
        * or the version of FitWorld which takes both a SegmentKey and a MatrixKit.
        ...
        /*! This method automatically adjusts the camera to fit the extents of a segment.
         *  In the general case, in_transform should be the product of all the MatrixKits found between the View segment and
         in_segment. \param in_segment The segment used to calculate the new camera. \param in_transform An optional transform to
         apply to the segment bounding used to compute the camera.  This can be used to ensure that the camera is looking at the
        ...
        \param in_bounding The bounding used to calculate the new camera.
        \param in_transform An optional transform to apply to the bounding used to compute the camera.  This can be used to ensure
        that the camera is looking at the geometry in the correct position once any modelling matrices are applied. */
        ...
        */
        ...
        /*! Makes an operator active on this View.  Assumes control of the memory of the operator.
            \deprecated It is recommended to use overloads which consume OperatorPtr as the object lifetime is simpler to reason
           about. \param in_operator the operator to be made active on this View. */
        ...
        AnimationControl const GetAnimationControl() const;
        ...
        /*! Redraws the View and all Layouts it appears in, including all of its child components using the default options, and
         * also returns a notifier to facilitate tracking the update progress. \return An UpdateNotifier object used to find out
        ...
        /*! Redraws the View and all Layouts it appears in, including all of its child components using the specified, and also
         *returns a notifier to facilitate tracking the update progress. \return HPS::UpdateNotifier to facilitate tracking the
         *update progress. \param in_type one of the enum values specified by HPS::Window::UpdateType \param in_time_limit the
         *maximum amount of time, in seconds, to spend updating this HPS::Canvas
         * \return An UpdateNotifier object used to find out information about the update. */
        UpdateNotifier UpdateWithNotifier(HPS::Window::UpdateType in_type, HPS::Time in_time_limit = -1.0) const;
    ...
    /*! The Model class is one of the four core display classes used in a Visualize application. It is meant to be used as part of
       a display hierarchy along with the Canvas, Layout, and View objects. The parent of the Model is the View. The Model is
       meant to represent a segment which contains a geometric
    ...
    class SPRK_API Model: public Sprocket {
      public:
        ...
        /*! Redraws the Model and all Views it appears in, including all of its child components using the default options, and
         * also returns a notifier to facilitate tracking the update progress. \return An UpdateNotifier object used to find out
         * information about the update. */
        UpdateNotifier UpdateWithNotifier() const;
        ...
        /*! Redraws the Model and all Views it appears in, including all of its child components using the specified, and also
         *returns a notifier to facilitate tracking the update progress. \return HPS::UpdateNotifier to facilitate tracking the
         *update progress. \param in_type one of the enum values specified by HPS::Window::UpdateType \param in_time_limit the
         *maximum amount of time, in seconds, to spend updating this HPS::Canvas
         * \return An UpdateNotifier object used to find out information about the update. */
        ...
        Animation CreateAnimation(char const* in_name);
    ...
    /*! The Layout class is one of the four core display classes used in a Visualize application. It is meant to be used as part
       of a display hierarchy along with the Canvas, View, and Model objects. The parent of the Layout is the Canvas, and a Layout
       can have multiple Views. The Layout is meant to describe the way the Views are presented in the Canvas. Like the other
       three core  objects, the Layout is backed by a HPS::SegmentKey. */
    class SPRK_API Layout: public Sprocket {
      public:
        ...
        /*! Redraws the Layout and all Canvases it appears in, including all of its child components using the default options,
         * and also returns a notifier to facilitate tracking the update progress. \return An UpdateNotifier object used to find
         * out information about the update. */
        UpdateNotifier UpdateWithNotifier() const;

        /*! Redraws the Layout and all Canvases it appears in, including all of its child components using the specified
         *parameters. \param in_type one of the enum values specified by HPS::Window::UpdateType
         *	\param in_time_limit the maximum amount of time, in seconds, to spend updating. */
        void Update(HPS::Window::UpdateType in_type, HPS::Time in_time_limit = -1.0) const;

        /*! Redraws the Layout and all Canvases it appears in, including all of its child components using the specified, and also
         *returns a notifier to facilitate tracking the update progress. \return HPS::UpdateNotifier to facilitate tracking the
         *update progress. \param in_type one of the enum values specified by HPS::Window::UpdateType \param in_time_limit the
         *maximum amount of time, in seconds, to spend updating this HPS::Canvas
         * \return An UpdateNotifier object used to find out information about the update. */
    ...
    class SPRK_API CanvasDeletedEvent: public Event {
      public:
        ...
        CanvasDeletedEvent(Canvas const& in_canvas): Event(), canvas(in_canvas)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "CanvasDeletedEvent"; }
    ...
    class SPRK_API LayoutDetachedEvent: public Event {
      public:
        ...
        LayoutDetachedEvent(Canvas const& in_canvas, Layout const& in_layout): Event(), canvas(in_canvas), layout(in_layout)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "LayoutDetachedEvent"; }
    ...
    class SPRK_API LayoutDeletedEvent: public Event {
      public:
        ...
        LayoutDeletedEvent(Layout const& in_layout): Event(), layout(in_layout)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "LayoutDeletedEvent"; }
    ...
    class SPRK_API ViewDetachedEvent: public Event {
      public:
        ...
        char const* ClassName() const override { return "ViewDetachedEvent"; }
    ...
    class SPRK_API ViewDeletedEvent: public Event {
      public:
        ...
        ViewDeletedEvent(View const& in_view): Event(), view(in_view)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "ViewDeletedEvent"; }
    ...
    class SPRK_API ModelDetachedEvent: public Event {
      public:
        ...
        ModelDetachedEvent(View const& in_view, Model const& in_model): Event(), view(in_view), model(in_model)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "ModelDetachedEvent"; }
    ...
    class SPRK_API ModelDeletedEvent: public Event {
      public:
        ...
        ModelDeletedEvent(Model const& in_model): Event(), model(in_model)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "ModelDeletedEvent"; }
    ...
    class SPRK_API CameraChangedEvent: public Event {
      public:
        ...
        CameraChangedEvent(View const& in_view): Event(), view(in_view)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        virtual intptr_t Freshen() const { return GetClassID(); }

        char const* ClassName() const override { return "CameraChangedEvent"; }
    ...
    class SPRK_API Operator: public Sprocket {
      public:
        ...
        {
            HPS_UNREFERENCED(in_attached_view);
            return;
        }
        ...
        {
            HPS_UNREFERENCED(in_detached_view);
            return;
        }
    ...
    class SPRK_API OperatorUtility {
        static double internal_acos(double x) { return (((x) < -1) ? (HPS::PI) : (((x) > 1) ? (0) : (acos(x)))); }

      public:
        enum ProjectedPlane { Plane_XY, Plane_YZ, Plane_XZ };
    ...
    class SPRK_API OperatorControl: public SprocketControl {
      public:
        ...
        /*! The move constructor creates a OperatorControl by transferring the underlying impl of the rvalue reference to this
         * OperatorControl thereby avoiding a copy and allocation.
         * 	\param in_that An rvalue reference to a OperatorControl to take the impl from.*/
        OperatorControl(OperatorControl&& in_that);

        /*! The move assignment operator transfers the underlying impl of the rvalue reference to this OperatorControl thereby
         * avoiding a copy. \param in_that An rvalue reference to a OperatorControl to take the impl from.
         ...
         *	\param in_priority The priority of the operator.  All those with Low priority will be below all those with <span
         *class='code'>Normal</span> priority which will, in turn, be below High priority operators. \return A reference to this
         *object. */
         ...
         *	Existing operators in use are unmodified but operators on top get priority.
         *	\deprecated It is recommended to use overloads which consume OperatorPtr as the object lifetime is simpler to reason
         *about. \param in_operator The operator to push to the top of the operator stack. \param in_priority The priority of the
         *operator.  All those with Low priority will be below all those with <span class='code'>Normal</span> priority which
         *will, in turn, be below High priority operators. \return A reference to this object. */
        ...
        /*! Removes the top operator from the <span class='code'>Normal</span> priority operator stack and passes a handle to it
         *to the user. The user is responsible for freeing memory associated with the operator. \param out_operator A handle to
         *the top operator, passed to the user. \return <span class='code'>true</span> if an operator was present, <span
         *class='code'>false</span> otherwise. */
         ...
         *	\deprecated It is recommended to use overloads which consume OperatorPtr as the object lifetime is simpler to reason
         *about. \param in_operator An operator to use on this view. \param in_priority The priority of the operator.  All those
         *with Low priority will be below all those with <span class='code'>Normal</span> priority which will, in turn, be below
         *High priority operators. \return A reference to this object. */
        OperatorControl& Set(Operator* in_operator, Operator::Priority in_priority = Operator::Priority::Default);

        /*! Sets a collection of operators as the only operators in use of the specified priority and assumes control of their
         *memory. This replaces any existing operators in use and frees the memory associated with them. \param in_operators An
         *array of source operators to be used. \param in_priority The priority of the operators.  All those with Low priority
         *will be below all those with <span class='code'>Normal</span> priority which will, in turn, be below High priority
         *operators. \return A reference to this object. */
        OperatorControl& Set(OperatorPtrArray& in_operators, Operator::Priority in_priority = Operator::Priority::Default);

        /*! Sets a collection of operators as the only operators in use  of the specified priority and assumes control of their
         *memory. This replaces any existing operators in use and frees the memory associated with them. \param in_count The
         *number of elements in the operator array. \param in_operators An array of source operators to be used. \param
         *in_priority The priority of the operators.  All those with Low priority will be below all those with <span
         *class='code'>Normal</span> priority which will, in turn, be below High priority operators. \return A reference to this
         *object. */
        OperatorControl&
            Set(size_t in_count, OperatorPtr in_operators[], Operator::Priority in_priority = Operator::Priority::Default);
        ...
        /*! Shows the top operator on the <span class='code'>Normal</span> priority operator stack.  The operator stack is
         *unmodified. \param out_operator The operator at the top of the operator stack
         *	\return <span class='code'>true</span> if an operator was present, <span class='code'>false</span> otherwise. */
        ...
        /*! Shows all <span class='code'>Normal</span> priority operators in use on this segment.  The operator stack is
         *unmodified. \param out_operators Handles to all <span class='code'>Normal</span> priority operators used by this View.
     ...
     *	\note The orientation of the NavigationCubeControl is specified by the model in the associated view. See <span
     *class='code'>\ref HPS::Model::SetOrientation()</span>.
     */
    class SPRK_API NavigationCubeControl: public SprocketControl {
      public:
        ...
        /*! The move constructor creates a NavigationCubeControl by transferring the underlying impl of the rvalue reference to
         * this NavigationCubeControl thereby avoiding a copy and allocation. \param in_that An rvalue reference to a
         * NavigationCubeControl to take the impl from.*/
        NavigationCubeControl(NavigationCubeControl&& in_that);

        /*! The move assignment operator transfers the underlying impl of the rvalue reference to this NavigationCubeControl
         * thereby avoiding a copy. \param in_that An rvalue reference to a NavigationCubeControl to take the impl from.
        ...
        NavigationCubeControl& SetLocation(Location in_location,
        ...
        /*! Gets the position of the subwindow containing the navigation cube.
         *	\return The offset to the initial position of the subwindow containing the navigation cube. */
         ...
         *	\return <span class='code'>true</span> if the text on the navigation cube is visible, <span class='code'>false</span>
         *otherwise. */
         ...
         *  Making the Navigation Cube interactive pushes the Navigation Cube operator on the current View's operator stack with
         * High priority \param in_interactivity the interactivity of this navigation cube \return A reference to this object.
         ...
         *	\return <span class='code'>true</span> if the navigation cube is interactive, <span class='code'>false</span>
         *otherwise. */
         ...
         *	\return the size of the subwindow containing the navigation cube, as a percentage of the main window. If the location
         *is Custom, this will return -1.0f. */
        float GetSize() const;
         ...
         * \param in_fallback_fonts An array of fonts to use in case the one specified in in_text_attributes cannot be found at
         *runtime. Generally this should be the same array passed to SetFallbackFonts. If the font specified is not found at
         *runtime, and no fallback fonts are specified, a stroked representation of the text will be used. Non-Latin characters
         *might render as boxes in this eventuality. \return A reference to this object. */
        NavigationCubeControl& SetText(char const* in_back_string,
                                       char const* in_top_string,
                                       char const* in_left_string,
                                       char const* in_front_string,
                                       char const* in_bottom_string,
                                       char const* in_right_string,
                                       HPS::TextAttributeKit const& in_text_attributes,
                                       HPS::UTF8Array const& in_fallback_fonts = HPS::UTF8Array());

        /*! Sets the material palette and text displayed on the navigation cube.
         * note that if you plan on using the navigation cube on a very large and pixel dense screen
         * (example: a large TV), if you wish to specify a custom text size, you should do so using
         * one of the window relative text sizes.
         * The material palette supplied to this function should originate from a material kit array with 9 entries.
         ...
         *runtime, and no fallback fonts are specified, a stroked representation of the text will be used. Non-Latin characters
         *might render as boxes in this eventuality. \return A reference to this object. */
        NavigationCubeControl& SetMaterialPaletteAndText(char const* in_material_palette,
                                                         char const* in_back_string,
                                                         char const* in_top_string,
                                                         char const* in_left_string,
                                                         char const* in_front_string,
                                                         char const* in_bottom_string,
         ...
         * \param out_fallback_fonts The fonts that will be used if the preferred font specified when setting text could not be
         * found at runtime. Can be empty. \return <span class='code'>true</span> if the navigation cube text was retrieved
         * successfully, <span class='code'>false</span> otherwise. */
        bool GetText(UTF8& out_back_string,
                     UTF8& out_top_string,
                     UTF8& out_left_string,
                     UTF8& out_front_string,
                     UTF8& out_bottom_string,
                     UTF8& out_right_string,
                     HPS::TextAttributeKit& out_text_attributes,
                     HPS::UTF8Array& out_fallback_fonts) const;
    ...
    class SPRK_API AxisTriadControl: public SprocketControl {
      public:
        ...
        /*! The move constructor creates a AxisTriadControl by transferring the underlying impl of the rvalue reference to this
         * AxisTriadControl thereby avoiding a copy and allocation. \param in_that An rvalue reference to a AxisTriadControl to
         * take the impl from.*/
        AxisTriadControl(AxisTriadControl&& in_that);

        /*! The move assignment operator transfers the underlying impl of the rvalue reference to this AxisTriadControl thereby
         * avoiding a copy. \param in_that An rvalue reference to a AxisTriadControl to take the impl from.
        ...
        HPS::AxisTriadControl& SetLocation(Location in_location,
        ...
        /*! Gets the position of the subwindow containing the axis triad.
         *	\return The offset to the position of the subwindow containing the axis triad. */
        HPS::IntRectangle GetPositionOffsets() const;
         ...
         *  Making the Axis Triad interactive pushes the Axis Triad operator on the current View's operator stack with High
         *priority \param in_interactivity the interactivity of this axis triad \return A reference to this object.
         ...
         *	\return the size of the subwindow containing the axis triad, as a percentage of the main window. If the location is
         *Custom, this will return -1.0f. */
        float GetSize() const;
    ...
    class SPRK_API Component: public Sprocket {
      public:
        ...
        enum class ComponentType : uint32_t {
            ...
            ParasolidModelFile = 0x00020001, //!< Abstract component representing the root of a Parasolid file. Does not map to
                                             //!< any Parasolid element.
            ParasolidAssembly =
                0x00020002, //!< Represents a PK_ASSEMBLY in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidInstance =
                0x00020003, //!< Represents a PK_INSTANCE in Parasolid.  This will be represented by a Parasolid::Component.

            ParasolidTopologyMask = 0x00060000, //!< Mask for any Parasolid topological items.
            ParasolidTopoBody =
                0x00060001, //!< Represents a PK_BODY in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidTopoRegion =
                0x00060002, //!< Represents a PK_REGION in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidTopoShell =
                0x00060003, //!< Represents a PK_SHELL in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidTopoFace =
                0x00060004, //!< Represents a PK_FACE in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidTopoLoop =
                0x00060005, //!< Represents a PK_LOOP in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidTopoFin =
                0x00060006, //!< Represents a PK_FIN in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidTopoEdge =
                0x00060007, //!< Represents a PK_EDGE in Parasolid.  This will be represented by a Parasolid::Component.
            ParasolidTopoVertex =
                0x00060008, //!< Represents a PK_VERTEX in Parasolid.  This will be represented by a Parasolid::Component.
        ...
        enum class DeleteMode {
            Standard, //!< Subcomponents will be deleted if they don't have multiple owners, otherwise their reference count will
                      //!< be decremented
            Full, //!< Subcomponents will always be deleted, even if they are shared
            StandardAndExchange //!< Subcomponents will deleted if they don't have multiple owners, otherwise their reference
                                //!< count will be decremented. The Exchange Entity associated to the Component will be deleted.
        };
        ...
        /*! The move constructor creates a Component by transferring the underlying object of the rvalue reference to this
         * Component. \param in_that An rvalue reference to a Component to take the underlying object from. */
         ...
         *	\return <span class='code'>true</span> if this Component has the given ComponentType mask, <span
         *class='code'>false</span> otherwise. */
        bool HasComponentType(ComponentType in_mask) const;

        /*! Adds a key to be associated with this Component.  This will additionally ensure this key can be used to find this
         *Component via CADModel::GetComponentFromKey on the owning CADModel. In general, this will either be a SegmentKey or a
         *GeometryKey (or a subclass thereof), but it may also be an IncludeKey, which is necessary for an instanced Component. If
         *an IncludeKey is associated with this Component, the underlying target of the include will be associated with this
         *Component, though the include will be stored as well to determine things like the associated KeyPath correctly. \param
         *in_key The key to associate with this Component. */
        void AddKey(Key const& in_key);

        /*! Get the underlying keys (if any) which represent this Component.  Generally this will either be a segment or geometry
         *key. \return The underlying keys (if any) which represent this Component. */
        KeyArray GetKeys() const;

        /*! Adds an owner to this Component.  This is intended to facilitate adding additional owners to an instanced Component,
         *and allows specifying the associated IncludeKey for the additional owner. It is possible to add an owner without adding
         *an IncludeKey, and, if desired, add the IncludeKey separately via AddKey. \param in_owner The Component to act as an
         *additional owner for this Component. \param in_include The IncludeKey for this Component for this new owner.  This
         *defaults to an uninitialized IncludeKey. */
        void AddOwner(Component& in_owner, IncludeKey const& in_include = IncludeKey());

        /*! Get the Component objects (if any) which "own" this Component.  Generally this will be a single element or no elements
         *for a root component.  It is possible for there to be multiple owners of a Component if it is instanced (i.e., it may
         *have both a prototype and a containing Component). \sa GetReferrers()
         *	\return The Component objects (if any) which "own" this Component. */
        ComponentArray GetOwners() const;

        /*! Get the subcomponent objects (if any) owned or referenced by this Component.  These Component objects would be deleted
         *if this Component is deleted. \return The subcomponent objects (if any) owned or referenced by this Component. */
        ComponentArray GetSubcomponents() const;

        /*! Gets all components under this Component that have the specified ComponentType mask.  This will examine this
         *subcomponents of this Component, the subcomponents of the subcomponents, and so on. \param in_type Mask of the
         *components to look for. \return The Component objects under this Component (if any) which have the specified mask. */
        ...
        /*! Gets the Component objects which refer to this Component (if any). These relationships are defined in the original CAD
         *file and can be arbitrarily assigned between Components. \n\n For the Exchange implementation of the Component
         *hierarchy, Referrers will typically indicate which PMI elements refer to the Component being inspected. \sa GetOwners()
         *	\return The Component objects which refer to this Component. */
        ComponentArray GetReferrers() const;

        /*! Get the Component objects (if any) which are referenced by this Component.  These are Component objects which are
         *associated with this Component, but not "owned" by this Component, and would not be deleted if this Component is deleted
         *(though the reference relationship will be removed).
        ...
        /*! Gets the name for this Component.  This is a convenience function equivalent to getting the "Name" metadata for this
         *Component.  If a Component does not have a name, an empty UTF8 object will be returned. \return The name (if any) for
         *this Component. */
        UTF8 GetName() const;
         ...
         * Removes this component from memory and invalidates any component objects referring to it. All owners of this component
         * will no longer have it as a subcomponent, all components that reference this component will no longer have it as a
         * reference, and the keys underlying this component will be deleted. Any subcomponents of this component that have
         * multiple owners will have this component removed as an owner.  Any subcomponents of this component that have only this
         * component as an owner will be recursively deleted via this function.
         *
         * Invoking this function on an instance of an object derived from Component will perform some additional cleanup relevant
         * to the derived type. For example, performing a delete on a CADModel will delete the default capture associated with the
         * CADModel, delete its associated Model, and delete the mapping information between keys and components, in addition to
         * performing all the operations for a generic component. See below for the behavior of derived types in the integrations
         * that create component trees.
         *
         * Lastly, note that it is not necessary to construct or cast a component to its specific type to ensure the appropriate
         * delete logic is used. The appropriate logic will always be invoked even if using a base Component object handle to a
         * derived type.
         *
         * <b>Exchange:</b>
         *
         * <em>\htmlonly Component, ProductOccurrence, Sheet, Capture, Filter \endhtmlonly </em>\n
         * Invoking delete on these types will not modify the associated Exchange data. It will remove the associated A3DEntity
         * pointer and component from the mapping data accessible via Exchange::CADModel::GetComponentFromEntity, and then it will
         * invoke the base Component delete logic. When invoking Delete on the last root HPS::Exchange::Component, the whole
         * subtree is deleted, but a new root HPS::Exchange::Component will be associated to the CADModel in order to be
         * consistent with HOOPS Exchange behavior. In this case, it has an empty product occurrence data structure with no child
         * at the HPS::Exchange::Component level.
         *
         * <em>\htmlonly CADModel \endhtmlonly </em>\n
         * Invoking delete on an Exchange::CADModel will delete the underlying A3DAsmModelFile via A3DAsmModelFileDelete <b>if</b>
         * Exchange::CADModel::GetEntityOwnership is true.  It will additionally clean up the associated A3DRWParamsPrcReadHelper
         * if one was created during import (see Exchange::ImportOptionsKit::SetPRCReadHelper). The mapping data between A3DEntity
         * pointers and components will also be deleted, and lastly it will invoke the delete logic for the base CADModel.
         *
         * <b>Parasolid:</b>
         *
         * <em>\htmlonly Component \endhtmlonly </em>\n
         * Invoking delete on this type will invoke PK_ENTITY_delete on the underlying Parasolid entity if the entity has class
         * PK_CLASS_assembly or PK_CLASS_body. It will remove this Parasolid entity and component from the mapping data accessible
         * via Parasolid::CADModel::GetComponentFromEntity, and then it will invoke the base Component delete logic.
         *
         * <em>\htmlonly CADModel \endhtmlonly </em>\n
         * The mapping data between Parasolid entities and components will be deleted, and then it will invoke the base CADModel
         * delete logic.
         *
         * <b>DWG:</b>
         *
         * <em>\htmlonly Component, Layer, Layout \endhtmlonly </em>\n
         * Invoking delete on these types will not modify the associated DWG database. It will simply invoke the base Component
         * delete logic.
         *
         * <em>\htmlonly CADModel \endhtmlonly </em>\n
         * Invoking delete on a DWG::CADModel will release the underlying AcDbDatabase via acdbReleaseHostDwg, and then it will
         * invoke the base CADModel delete logic. \param mode The DeleteMode that we will use.
         */
        void Delete(HPS::Component::DeleteMode mode = HPS::Component::DeleteMode::Standard);

        /*! Removes all references to the underlying subcomponents, but leaves this Component around. If a subcomponent of the
         *component being flushed has multiple owners, the flush will simply remove the reference to that subcomponent.  If a
         *subcomponent of the component being flushed has only one owner
         *	(the component being flushed), that subcomponent will be deleted.  Any handles to the deleted components will become
         *invalid. */
        void Flush();

        /*! Gets the list of KeyPath objects that correspond to the given Component.  There will be at least one KeyPath, and
         *possibly more than one if a particular Component is instanced, e.g., if the Component corresponds to the wheel of a car,
         *a KeyPath would be returned for each wheel (driver side front and rear, and passenger side front and rear).  Each
         *KeyPath in the list will also include the portion of the path above the Model (associated with the root CADModel) for
         *each View, Layout layer, and Canvas permutation which includes the Model.  This function will not take into account any
         *includes or paths which do not come from the Component hierarchy or the View, Layout, and Canvas permutations which
         *include the Model. \param in_component The Component for which to compute the corresponding KeyPath objects. \return A
         *list of all KeyPath objects which refer to the given Component. \sa HighlightControl */
        static KeyPathArray GetKeyPath(Component const& in_component);

        /*! Gets the list of KeyPath objects that correspond to the given ComponentPath.  This function can be used to get the
         *KeyPath for a particular instance of an instanced Component.  For a non-instanced Component, since the ComponentPath can
         *be determined unambiguously, the KeyPath returned will be the same as if only the leaf non-instanced Component was given
         *to this function.  There will be at least one KeyPath returned, and possibly more than one for each View, Layout layer,
         *and Canvas which include the Model associated with the root CADModel.  This function will not take into account any
         *includes or paths which do not come from the Component hierarchy or the View, Layout, and Canvas permutations which
         *include the Model. \param in_count Size of the following array. \param in_components The ComponentPath for which to
         *compute the corresponding KeyPath objects.  The path should be defined such that the first element is the leaf
         *Component, and the last element is the root CADModel.  Each element in the path should be an owner of the preceding
         *Component, otherwise an exception will be thrown. \return A list of all KeyPath objects which refer to the given
         *Component. \sa HighlightControl */
         ...
         *and Canvas which include the Model associated with the root CADModel.  This function will not take into account any
         *includes or paths which do not come from the Component hierarchy or the View, Layout, and Canvas permutations which
         *include the Model. \param in_components The ComponentPath for which to compute the corresponding KeyPath objects.  The
         *path should be defined such that the first element is the leaf Component, and the last element is the root CADModel.
         *Each element in the path should be an owner of the preceding Component, otherwise an exception will be thrown. \return A
         *list of all KeyPath objects which refer to the given Component. \sa HighlightControl */
        static KeyPathArray GetKeyPath(ComponentArray const& in_components);

        /*! Applies a transform to the underlying PRC or Parasolid data associated with this component, replacing any transforms
         *currently set on it. \warning For Parasolid components, only transformations which are rigid motions can be applied.
         *Calling SetTransform from a Parasolid component with a transform which is not a rigid motion, such as a shear, will
         *cause the function to fail. \warning For Exchange components, only components of type ExchangeProductOccurrence, or
         *components that have the type ExchangeRepresentationItemMask can have transforms applied to them. Additionally,
         *SetTransform does not work on Exchange models which have a Drawing structure to them. This would include CATDrawing
         *files and 2D DWG files loaded through Exchange. Any attempt to use this function on those models will produce a warning.
         ...
         *   \warning For Parasolid components, only transformations which are rigid motions can be applied. Calling SetTransform
         *from a Parasolid component with a transform which is not a rigid motion, such as a shear, will cause the function to
         *fail. \warning For Exchange components, only components of type ExchangeProductOccurrence, or components that have the
         *type ExchangeRepresentationItemMask can have transforms applied to them. Additionally, SetTransform does not work on
         *Exchange models which have a Drawing structure to them. This would include CATDrawing files and 2D DWG files loaded
         *through Exchange. Any attempt to use this function on those models will produce a warning. \param in_transform The
         *transform to apply to this component. \return <span class='code'>true</span> if transform was applied correctly, <span
         *class='code'>false</span> otherwise. */
        bool AddTransform(MatrixKit const& in_transform);

        /*! Creates a deep copy of this component under another component. Please note how entity copying is handled for each type
         *of entity:
         *
         *   <ul>
         *       <li>Copying a RepresentationItem to a ProductOccurrence: The copy of the representation item will be inserted
         *under the Part Definition under the target Product Occurrence</li> <li>Copying a RepresentationItem to a PartDefinition:
         *supported</li> <li>Copying a RepresentationItem to a RepresentationItemSet: supported</li> <li>Copying a PartDefinition
         *to a ProductOccurrence: The function will create a new ProductOccurrence object, insert the copy into the children of
         *this product occurrence and then insert this product occurrence under the target product occurrence. This is to avoid
         *rewrite on the original PartDefinition of the target ProductOccurrence (if one exists)</li> <li>Copying a
         *ProductOccurrence to a ProductOccurrence: The newly created copy will be inserted under the target Product Occurrence.
         *However we need to note that if the target ProductOccurrence already has a prototype, the prototype will not be
         *visualized by HPS but only the newly created copy will be. In the case of ExternalData, both will be rendered by
         *HPS.</li> <li>Copying a ProductOccurrence to a Exchange ModelFile: The A3DAsmModelFile under the target component will
         *be deleted, and a new one will be created. This new model is identical with the old model except that the copy of the
         *source ProductOccurrence will be inserted under this new model. In this case, since we create a new CADModel, the reload
         *process may take more time since we need to re-render the whole new model.</li>
         *   </ul>
         *
         *   In any case, if the function fails, it will return an empty Component, so checking if the type of the returned
         *component is <span class='code'>None</span> or not can be considered a way to test if the function succeeded or failed.
         *
         *   Additional notes about the deep copy process: The deep copy process for ProductOccurrence and RepresentationItem uses
         *two functions of Exchange: <span class='code'>A3DAsmProductOccurrenceDeepCopy</span> and <span
         *class='code'>A3DRiRepresentationItemDeepCopy</span>. These functions can make changes to the structure of the entity, so
         *we may not have a copy that is an exact replica of the source entity. More on this can be found here:
         *https://docs.techsoft3d.com/exchange/latest/api/group__a3d__productoccurrence.html#_CPPv431A3DAsmProductOccurrenceDeepCopyPK23A3DAsmProductOccurrencePP23A3DAsmProductOccurrence
         *and
         *https://docs.techsoft3d.com/exchange/latest/api/group__a3d__ricontent.html#_CPPv431A3DRiRepresentationItemDeepCopyPK23A3DRiRepresentationItemPP23A3DRiRepresentationItem
         *
         *   For PartDefinition and RepresentationItemSet, which lack a deep copy function in Exchange, the PartDefinition is only
         *shallow copied, so its children pointers are shared between the source and the target. The deep copy process copies all
         *the attributes of the source entity, thus, if the modelling matrix of the source entity if relative to its parents, the
         *location of the copied entity will also be relative to its new parents.
         *
    ...
    /*! The ComponentPath contains an array of components, organized from leaf to root.  It allows the user to perform queries and
     * operations along that path. */
    class SPRK_API ComponentPath: public Sprocket {
      public:
        ...
        /*! The move constructor creates a ComponentPath by transferring the underlying impl of the rvalue reference to this
         * ComponentPath thereby avoiding a copy and allocation.
         * 	\param in_that An rvalue reference to a ComponentPath to take the impl from.*/
        ComponentPath(ComponentPath&& in_that);

        /*! The move assignment operator transfers the underlying impl of the rvalue reference to this ComponentPath thereby
         * avoiding a copy. \param in_that An rvalue reference to a ComponentPath to take the impl from. \return A reference to
         * this ComponentPath. */
         ...
         * 	\return <span class='code'>true</span> if no components are set on the path, <span class='code'>false</span>
         * otherwise. */
        bool Empty() const;
        ...
        /*! Gets the KeyPath objects corresponding to this ComponentPath.  These key paths will include all possible paths which
         *include the path components and all Canvas, Layout and View paths which include the Model which contains the path
         *components. \return All KeyPath objects for this ComponentPath. */
         ...
         *  \param in_remove_existing Indicates whether this highlight should flush existing highlights at the specified path for
         the desired overlay type. If <span class='code'>\ref HPS::ComponentPath::Isolate()</span>, <span class='code'>\ref
         HPS::ComponentPath::Hide()</span>, or <span class='code'>\ref HPS::ComponentPath::Show()</span>
            have been called on this ComponentPath, in_remove_existing should be set to false so that it doesn't override those
         visibility states.  */
         ...
         *	\param in_options The options to use to perform the highlight.
            If <span class='code'>\ref HPS::ComponentPath::Isolate()</span>, <span class='code'>\ref
         HPS::ComponentPath::Hide()</span>, or <span class='code'>\ref HPS::ComponentPath::Show()</span>
            have been called on this ComponentPath, in_remove_existing should be set to false so that it doesn't override those
         visibility states.  */
        void Highlight(Canvas const& in_canvas,
                       size_t in_layer,
                       HighlightOptionsKit const& in_options,
                       bool in_remove_existing = true) const;
         ...
         *	\param in_options The options to use to perform the unhighlight. */
        void Unhighlight(Canvas const& in_canvas,
                         size_t in_layer,
                         HighlightOptionsKit const& in_options = HighlightOptionsKit()) const;

        /*! Hides this ComponentPath under the given Canvas in the specified layer. This forces the visibility of the selected
         *ComponentPath and all components under this path to invisible. Any visibility changes made previously at or below this
         *path are flushed. When performing a highlight in combination with this function the highlight must be applied with
         *Drawing::Overlay::InPlace to display properly. See <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this section</a> for limitations and
         *details on managing component visibility. \param in_canvas The Canvas in which to hide the ComponentPath. \param
         *in_layer The layer under the provided Canvas in which to hide the ComponentPath. \sa Show \sa Isolate \sa IsHidden \sa
         *ResetVisibility \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        void Hide(Canvas const& in_canvas, size_t in_layer = 0);

        /*! Shows this ComponentPath under the given Canvas in the specified layer. This makes the selected path visibile but
         *preserves the model-defined visibility of any components that exist underneath the chosen path. Any visibility changes
         *made subsequently at or below this path are honored unless they are redundant. When performing a highlight in
         *combination with this function the highlight must be applied with Drawing::Overlay::InPlace to display properly. See <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this section</a> for limitations and
         *details on managing component visibility. \param in_canvas The Canvas in which to show the ComponentPath. \param
         *in_layer The layer under the provided Canvas in which to show the ComponentPath. \sa Hide \sa Isolate \sa IsHidden \sa
         *ResetVisibility \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        void Show(Canvas const& in_canvas, size_t in_layer = 0);

        /*! Indicates whether this ComponentPath under the given Canvas in the specified layer is hidden. Note that even if a path
         *is hidden, it's possible that paths descending from this path may not be hidden. \param in_canvas The Canvas in which to
         *check whether the specified path is hidden. \param in_layer The layer under the provided Canvas in which to check
         *whether the specified path is hidden. \return <span class='code'>true</span> if this path is hidden, <span
         *class='code'>false</span> otherwise. \sa Hide \sa Show \sa Isolate \sa ResetVisibility \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
         ...
         *	When performing a highlight in combination with this function the highlight must be applied with
         *Drawing::Overlay::InPlace to display properly. See <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this section</a> for limitations and
         *details on managing component visibility. \param in_canvas The Canvas in which to isolate the ComponentPath. \param
         *in_layer The layer under the provided Canvas in which to isolate the ComponentPath. \sa Hide \sa Show \sa IsHidden \sa
         *ResetVisibility \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        void Isolate(Canvas const& in_canvas, size_t in_layer = 0);

        /*! Shows only the objects in the supplied ComponentPathArray and hides all other Component objects under the given Canvas
         *in the specified layer. When performing a highlight in combination with this function the highlight must be applied with
         *Drawing::Overlay::InPlace to display properly. See <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this section</a> for limitations and
         *details on managing component visibility. \param in_component_paths A ComponentPathArray containing paths to isolate.
         ...
         *  \sa IsHidden
         *  \sa ResetVisibility
         *  \sa Programming Guide: <a href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing
        ...
        /*! Resets the visibility of all components at or below this ComponentPath back to the visibility state defined by their
         *model & view. See <a href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this
         *section</a> for limitations and details on managing component visibility. \param in_canvas The Canvas in which to
         *isolate the ComponentPath. \param in_layer The layer under the provided Canvas in which to isolate the ComponentPath.
         *	\sa Hide
         *	\sa Show
         *	\sa Isolate
         *  \sa IsHidden
         ...
         * @param path The path to teh segment to set the visibility of.
         * @param visible True to make the segment visible, false to make it invisible.
         */
        static void SetPathMetaVisible(HPS::KeyPath const& path, bool visible);

        /*! Resets the visibility of all components at or below the given paths back to the visibility state defined by their
         *model & view. See <a href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this
         *section</a> for limitations and details on managing component visibility. \param in_component_paths A ComponentPathArray
         *containing paths to reset. \param in_canvas The Canvas in which to isolate the supplied paths. \param in_layer The layer
         *under the provided Canvas in which to isolate the supplied paths. \sa Hide \sa Show \sa Isolate \sa IsHidden \sa
         *Programming Guide: <a href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing
         *Component Visibility</a>
         */
        ...
        /*! Access a Component in this ComponentPath object. An HPS::IndexOutOfRangeException exception is thrown if in_index is
         * out of range. \param in_index The index of the Component to access, zero based. \return The Component at position
         * in_index in this ComponentPath.*/
        ...
        /*! Inserts in_item in the ComponentPath before the element at position in_index, increasing the size of the ComponentPath
         * by one. An HPS::IndexOutOfRangeException exception is thrown if in_index is out of range. \param in_index The index
         * where in_item will be inserted \param in_item The component to insert in this key path. */
        ...
        /*! Removes the the component at position in_index from this ComponentPath. An HPS::IndexOutOfRangeException exception is
         * thrown if in_index is out of range. \param in_index The index of the component to remove, zero based. */
        ...
        /*! Returns the first component of this ComponentPath. An HPS::IndexOutOfRangeException exception is thrown if the
         * ComponentPath is empty. \return The first component of this ComponentPath.*/
        Component& Front();
        ...
        /*! Returns the last component of this ComponentPath. An HPS::IndexOutOfRangeException exception is thrown if the
         * ComponentPath is empty. \return The last component of this ComponentPath.*/
        Component& Back();
        ...
        /*! Returns the first component of this ComponentPath and returns it. An HPS::IndexOutOfRangeException exception is thrown
         * if the ComponentPath is empty. \return The first component of this ComponentPath.*/
        Component PopFront();

        /*! Returns the last component of this ComponentPath and returns it. An HPS::IndexOutOfRangeException exception is thrown
         * if the ComponentPath is empty. \return The last component of this ComponentPath.*/
        Component PopBack();
     ...
     *	\param in_lhs The first Component in the returned ComponentPath.
     *	\param in_rhs The ComponentPath to append to the first Component in the returned ComponentPath.  This ComponentPath will
     *be unchanged. \return A new ComponentPath object representing the concatenation of a Component and ComponentPath. */
     ...
     *	\param in_lhs The Component array at the beginning of the returned ComponentPath.
     *	\param in_rhs The ComponentPath to append to the Component array in the returned ComponentPath.  This ComponentPath will
     *be unchanged. \return A new ComponentPath object representing the concatenation of a Component array and a ComponentPath. */
    ...
    class SPRK_API ComponentResetEvent: public HPS::Event {
      public:
        ...
        char const* ClassName() const override { return "ComponentResetEvent"; }
    ...
    class SPRK_API ComponentShownEvent: public HPS::Event {
      public:
        ...
        char const* ClassName() const override { return "ComponentShownEvent"; }
    ...
    class SPRK_API ComponentHiddenEvent: public HPS::Event {
      public:
        ...
        char const* ClassName() const override { return "ComponentHiddenEvent"; }
    ...
    class SPRK_API ComponentIsolatedEvent: public Event {
      public:
        ...
        char const* ClassName() const override { return "ComponentIsolatedEvent"; }
    ...
    class SPRK_API ComponentHighlightEvent: public Event {
      public:
        ...
        ComponentHighlightEvent(Action in_action,
            ...
            Event(),
            action(in_action), path(in_path), options(in_options), canvas(in_canvas), layer(in_layer)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "ComponentHighlightEvent"; }
    ...
    class SPRK_API Filter: public Component {
      public:
        ...
        /*! This constructor creates a Filter object that shares the underlying smart-pointer of the source Component.  The copy
         *will only be successful if the source component is really an upcast of a Filter object.  Otherwise the copy will fail
         *and the resulting Filter will be invalid. \param in_that The source Component to copy. */
        ...
        /*! Activates this Filter on a given View.  The View must have an attached CADModel which this Filter belongs to,
         *otherwise an exception will be thrown. \param in_view The View on which to activate this Filter. */
        void Activate(View const& in_view);

        /*! Dectivates this Filter on a given View.  The View must have this Filter activated on it, otherwise an exception will
         *be thrown. \param in_view The View on which to deactivate this Filter. */
    ...
    class SPRK_API FilterActivationEvent: public Event {
      public:
        ...
        FilterActivationEvent(Filter in_filter, Action in_action, View in_view):
            Event(), filter(in_filter), action(in_action), view(in_view)
        {
            channel = GetClassID();
            consumable = false;
        }
        ...
        char const* ClassName() const override { return "FilterActivationEvent"; }
    ...
    /*! The Capture class is a smart pointer.  It represents a capture, i.e., a collection of visibility settings, material
     * settings, transformation settings, and camera, for a CADModel. */
    class SPRK_API Capture: public Component {
      public:
        ...
        /*! This constructor creates a Capture object that shares the underlying smart-pointer of the source Component.  The copy
         *will only be successful if the source component is really an upcast of a Capture object.  Otherwise the copy will fail
         *and the resulting Capture will be invalid. \param in_that The source Component to copy. */
        ...
        /*! Creates a new View object corresponding to this Capture.  The View object that is returned will have the corresponding
         *visibility settings, material settings, transformation settings, and camera from this Capture set on it.
    ...
    class SPRK_API CaptureActivationEvent: public Event {
      public:
        ...
        char const* ClassName() const override { return "CaptureActivationEvent"; }
    ...
    enum class SPRK_API MeasurementType {
        PointToPoint,
        EdgeAndRadius,
        FeatureToFeature,
        FaceAngle,
     ...
     */
    class SPRK_API Measurement {
        HPS::ComponentPathArray components;
        SegmentKey segment;
        MeasurementType type = MeasurementType::PointToPoint;
        KeyPath keyPath;
        Canvas canvas;
        static constexpr HPS::Drawing::Overlay overlay = HPS::Drawing::Overlay::Default;
      ...
      public:
         ...
         * @param paths The paths of the measurement
        ...
        MeasurementType GetMeasurementType() const { return type; }

        SegmentKey GetMeasurementSegment() const { return segment; }

        HPS::ComponentPathArray const& Components() const { return components; }
        ...
        /*!
         * Modify the meta visibility of the measurement.
         * The meta visibility is the ability to show a measurement with the Isolate activated.
         * @param visible the wanted visibility
         */
    ...
    typedef std::vector<HPS::Measurement, Allocator<HPS::Measurement>> MeasurementArray;
    ...
    class SPRK_API CADModel: public Component {
      public:
        ...
        /*! This constructor creates a CADModel object that shares the underlying smart-pointer of the source Component.  The copy
         *will only be successful if the source component is really an upcast of a CADModel object.  Otherwise the copy will fail
         *and the resulting CADModel will be invalid. \param in_that The source Component to copy. */
        ...
        /*! The move constructor creates a CADModel by transferring the underlying object of the rvalue reference to this
         * CADModel. \param in_that An rvalue reference to a CADModel to take the underlying object from. */
        CADModel(CADModel&& in_that);

        /*! This constructor creates a CADModel object that is associated with the given Model.  This will throw an exception if
         *the given Model is not associated with a CADModel. \param in_that The source Model to use to find the associated
         *CADModel. */
         ...
         *\n\n If the path type requested is Unique, Components associated with keys which are implicitly along the key path will
         *be included in the returned path, provided they can be determined unambiguously. \n\n If the path type requested is
         *Complete, all Components associated with keys which are implicitly along the path will be included in the returned path,
         *	if an entry cannot be determined unambiguously, it will be filled with the first eligible component found.
         *\n\n Example: a component with two owners will select the first owner out of the two, if the key path does not specify
         *which of the two owners to consider, when using a Complete path type. It will instead not include any of the two owners
         *when using Unique path type. \n\n This function will throw an InvalidSpecificationException if the provided key path
         *does not proceed from leaf to root.  An error will be logged if the key path is ambiguous, and only components
         *associated with the explicit keys in the key path will be returned in this case. \param in_key_path The KeyPath for
         *which to compute the corresponding ComponentPath. \param in_path_type The type of ComponentPath returned by this
         *function. \return The ComponentPath corresponding to the given KeyPath. */
        ComponentPath GetComponentPath(KeyPath const& in_key_path,
                                       ComponentPath::PathType in_path_type = ComponentPath::PathType::Unique) const;

        /*! Get the ComponentPath which corresponds to the given SelectionItem.  The returned path will be the Component
         *associated with each key which occurs along the KeyPath associated with the SelectionItem, up to the CADModel. \n\n If
         *the path type requested is Unique, Components associated with keys which are implicitly along the key path will be
         *included in the returned path, provided they can be determined unambiguously. \n\n If the path type requested is
         *Complete, all Components associated with keys which are implicitly along the path will be included in the returned path,
         *	if an entry cannot be determined unambiguously, it will be filled with the first eligible component found.
         *\n\n Example: a component with two owners will select the first owner out of the two, if the key path associated with
         *the selection path does not specify which of the two owners to consider, when using a Complete path type. It will
         *instead not include any of the two owners when using Unique path type. \n\n This function will throw an
         *InvalidSpecificationException if the provided key path does not proceed from leaf to root.  An error will be logged if
         *the key path is ambiguous, and only components associated with the explicit keys in the key path will be returned in
         *this case. \param in_item The SelectionItem for which to compute the corresponding ComponentPath. \param in_path_type
        ...
        /*! Creates a new View object corresponding to the default capture for this CADModel.  The View object that is returned
         *will have the corresponding visibility settings, material settings, transformation settings, and camera for the default
         *capture set on it. \return A newly created View object corresponding to this Capture. */
        View ActivateDefaultCapture();

        /*! Resets the visibility in the view specified by the given Canvas and layer.  This will undo any hides, shows or
         *isolates performed on components contained within this CADModel via ComponentPath calls. \param in_canvas The Canvas in
         *which to perform the the visibility reset. \param in_layer The layer in the Canvas in which to perform the visibility
         *reset. \sa ComponentPath::Hide \sa ComponentPath::Show \sa ComponentPath::Isolate */
        void ResetVisibility(Canvas const& in_canvas, size_t in_layer = 0);
    };

    /*!	The Metadata class is a smart pointer.  It represents a variety of metadata, i.e., a (name, value) pair, which might be
     *associated with a Component, e.g., IDs, names, layers, user-defined or format-specific attributes, etc. */
    class SPRK_API Metadata: public Sprocket {
      public:
        ...
        /*! The move constructor creates a Metadata by transferring the underlying object of the rvalue reference to this
         * Metadata. \param in_that An rvalue reference to a Metadata to take the underlying object from. */
    ...
    class SPRK_API IntegerMetadata: public Metadata {
      public:
        ...
        /*! This constructor creates an IntegerMetadata object that shares the underlying smart-pointer of the source Metadata.
         *The copy will only be successful if the source component is really an upcast of an IntegerMetadata object.  Otherwise
         *the copy will fail and the resulting IntegerMetadata will be invalid. \param in_that The source Metadata to copy. */
        IntegerMetadata(Metadata const& in_that);

        /*! The copy constructor creates an IntegerMetadata object that shares the underlying smart-pointer of the source
         *IntegerMetadata. \param in_that The source IntegerMetadata to copy. */
        IntegerMetadata(IntegerMetadata const& in_that);

        /*! The move constructor creates an IntegerMetadata by transferring the underlying object of the rvalue reference to this
         * IntegerMetadata. \param in_that An rvalue reference to an IntegerMetadata to take the underlying object from. */
    ...
    class SPRK_API UnsignedIntegerMetadata: public Metadata {
      public:
        /*! The default constructor creates an uninitialized UnsignedIntegerMetadata object.  The Type() function will return
         * Type::None. */
        UnsignedIntegerMetadata();

        /*! This constructor creates an UnsignedIntegerMetadata object that shares the underlying smart-pointer of the source
         *Metadata.  The copy will only be successful if the source component is really an upcast of an UnsignedIntegerMetadata
         *object.  Otherwise the copy will fail and the resulting UnsignedIntegerMetadata will be invalid. \param in_that The
         *source Metadata to copy. */
        UnsignedIntegerMetadata(Metadata const& in_that);

        /*! The copy constructor creates an UnsignedIntegerMetadata object that shares the underlying smart-pointer of the source
         *UnsignedIntegerMetadata. \param in_that The source UnsignedIntegerMetadata to copy. */
        UnsignedIntegerMetadata(UnsignedIntegerMetadata const& in_that);

        /*! The move constructor creates an UnsignedIntegerMetadata by transferring the underlying object of the rvalue reference
         * to this UnsignedIntegerMetadata. \param in_that An rvalue reference to an UnsignedIntegerMetadata to take the
    ...
    class SPRK_API DoubleMetadata: public Metadata {
      public:
        ...
        /*! This constructor creates a DoubleMetadata object that shares the underlying smart-pointer of the source Metadata.  The
         *copy will only be successful if the source component is really an upcast of a DoubleMetadata object.  Otherwise the copy
         *will fail and the resulting DoubleMetadata will be invalid. \param in_that The source Metadata to copy. */
        DoubleMetadata(Metadata const& in_that);

        /*! The copy constructor creates a DoubleMetadata object that shares the underlying smart-pointer of the source
         *DoubleMetadata. \param in_that The source DoubleMetadata to copy. */
        DoubleMetadata(DoubleMetadata const& in_that);

        /*! The move constructor creates a DoubleMetadata by transferring the underlying object of the rvalue reference to this
         * DoubleMetadata. \param in_that An rvalue reference to a DoubleMetadata to take the underlying object from. */
    ...
    class SPRK_API StringMetadata: public Metadata {
      public:
        ...
        /*! This constructor creates a StringMetadata object that shares the underlying smart-pointer of the source Metadata.  The
         *copy will only be successful if the source component is really an upcast of a StringMetadata object.  Otherwise the copy
         *will fail and the resulting StringMetadata will be invalid. \param in_that The source Metadata to copy. */
        StringMetadata(Metadata const& in_that);

        /*! The copy constructor creates a StringMetadata object that shares the underlying smart-pointer of the source
         *StringMetadata. \param in_that The source StringMetadata to copy. */
        StringMetadata(StringMetadata const& in_that);

        /*! The move constructor creates a StringMetadata by transferring the underlying object of the rvalue reference to this
         * StringMetadata. \param in_that An rvalue reference to a StringMetadata to take the underlying object from. */
    ...
    /*!	The TimeMetadata class is a smart pointer.  It represents a piece of time Metadata, i.e., a 32-bit integer to be
     * interpreted as time_t. */
    class SPRK_API TimeMetadata: public Metadata {
      public:
        ...
        /*! This constructor creates a TimeMetadata object that shares the underlying smart-pointer of the source Metadata.  The
         *copy will only be successful if the source component is really an upcast of a TimeMetadata object.  Otherwise the copy
         *will fail and the resulting TimeMetadata will be invalid. \param in_that The source Metadata to copy. */
        TimeMetadata(Metadata const& in_that);

        /*! The copy constructor creates a TimeMetadata object that shares the underlying smart-pointer of the source
         *TimeMetadata. \param in_that The source TimeMetadata to copy. */
        TimeMetadata(TimeMetadata const& in_that);

        /*! The move constructor creates a TimeMetadata by transferring the underlying object of the rvalue reference to this
         * TimeMetadata. \param in_that An rvalue reference to a TimeMetadata to take the underlying object from. */
    ...
    class SPRK_API BooleanMetadata: public Metadata {
      public:
        ...
        /*! This constructor creates a BooleanMetadata object that shares the underlying smart-pointer of the source Metadata. The
         *copy will only be successful if the source component is really an upcast of a BooleanMetadata object.  Otherwise the
         *copy will fail and the resulting BooleanMetadata will be invalid. \param in_that The source Metadata to copy. */
        BooleanMetadata(Metadata const& in_that);

        /*! The copy constructor creates a BooleanMetadata object that shares the underlying smart-pointer of the source
         *BooleanMetadata. \param in_that The source BooleanMetadata to copy. */
        BooleanMetadata(BooleanMetadata const& in_that);

        /*! The move constructor creates a BooleanMetadata by transferring the underlying object of the rvalue reference to this
         * BooleanMetadata. \param in_that An rvalue reference to a BooleanMetadata to take the underlying object from. */
    ...
    class SPRK_API Factory: public Sprocket {
      public:
         ...
         * \param in_options An ApplicationWindowOptionsKit used to specify the driver to be used by the canvas, and whether it
         * will support anti-aliasing. \return The newly created Canvas. */
        static Canvas CreateCanvas(HPS::WindowHandle in_window_handle,
                                   char const* in_name = "",
        ...
        /*! Creates a new Canvas.
         * \param in_name An optional name associated with this Canvas.
         * \param in_options An StandAloneWindowOptionsKit used to specify the driver to be used by the canvas, and whether it
         * will support anti-aliasing. Note: This is not supported on Android, iOS or macOS as this uses standalone windows and on
         * these operating systems all GUI / windowing is controlled at the application level. \return The newly created Canvas.
         */
        static Canvas CreateCanvas(char const* in_name = "",
        ...
        static Canvas CreateCanvas(HPS::WindowKey const& in_window_key,
    ...
    class SPRK_API AxisTriadOperator: public Operator {
      public:
        AxisTriadOperator(MouseButtons in_mouse_trigger = MouseButtons::ButtonLeft(),
    ...
    class SPRK_API SmoothTransitionCompleteEvent: public HPS::Event {
      public:
        ...
        char const* ClassName() const override { return "SmoothTransitionCompleteEvent"; }
    ...
    *			<tr><td>Left Button Down:</td><td>			Snap view to plane</td></tr>
     ...
     *		</table>
     *
     *	<p>In order to use the NavigationCubeOperator, it's necessary to call <span class='code'>\ref
    HPS::NavigationCubeControl::SetInteractivity() "HPS::NavigationCubeControl::SetInteractivity(true)"</span> first.
        </p>
     * 	\note The orientation of the NavigationCubeControl is specified by the model in the associated view. See <span
    class='code'>\ref HPS::Model::SetOrientation()</span>.
     */
    class SPRK_API NavigationCubeOperator: public Operator {
      public:
        NavigationCubeOperator(MouseButtons in_mouse_trigger = MouseButtons::ButtonLeft(),
                               ModifierKeys in_modifier_trigger = ModifierKeys());
        ...
        /*! Sets a key path to the segment used as a reference.
           All rotations use the transformed bounding of the segment pointed to by the path provided in order to correctly
           position the camera. By default the reference segment is the View segment. \param in_path_to_segment the key path to
           the segment to rotate around. */
         ...
         * All rotations happen around the combined bounding box of the reference segments, taking into account transformation
         sets along their key paths By default the reference segment is the View segment.
         ...
         * \param in_time how long the navigation cube will take to complete a transition when a user clicks on one of its faces.
         * Specified in seconds. \return A reference to this object. By default the navigation cube will take 0.5 seconds to
         * complete transitions. */
        void SetTransitionTime(HPS::Time const& in_time);

        /*! Gets the duration of transitions, specified in seconds.
         *	\return How long it will take the navigation cube to complete a transition when a user clicks on one of its faces, in
         *seconds */
    ...
    /*! The SceneTree class is a smart pointer which corresponds to a tree object in a GUI toolkit, e.g., a TreeView in WPF or a
     *CTreeCtrl in MFC. This class can be derived from to facilitate tree creation in the various GUI toolkits.  It is used to
     *create a scene graph or segment browser. */
    class SPRK_API SceneTree: public Sprocket {
      public:
        ...
        enum class ItemType : uint32_t {
            ...
            ConditionalExpression = 0x00000003, //!< Item is a logical conditional expression.  This is the condition associated
                                                //!< with a conditional include, reference or style.
            ...
            NamedStyle =
                0x00020003, //!< Item is a StyleKey for a name of a NamedStyleDefinition that was styled onto a SegmentKey.
            ...
            PBRMaterial = 0x0002002a, //!< Item is a MaterialMappingKit on a SegmentKey.
            ...
            LegacyShaderDefinition = 0x00040008, //!< Item is a LegacyShaderDefinition in a PortfolioKey.
            ...
            LegacyShaderDefinitionGroup = 0x00180e00, //!< Item is a collection of LegacyShaderDefinition objects.
            ...
            InfiniteLineGroup =
                0x00280010, //!< Item is a collection of InfiniteLineKey (of type InfiniteLine::Type::Line) objects.
        ...
        /*! This constructor creates a SceneTree object associated with a Canvas.  This constructor should be used to create a new
         *SceneTree object. \param in_canvas The Canvas to associate this SceneTree with. */
        ...
        /*! The move constructor creates a SceneTree by transferring the underlying object of the rvalue reference to this
         * SceneTree. \param in_that An rvalue reference to a SceneTree to take the underlying object from. */
        ...
        /*!	Sets the highlight options that will be used by this SceneTree.  These options are used to perform highlights of
         *elements within the tree and to determine what items within the tree need to be marked as selected when highlights are
         *performed by a HighlightOperator or HighlightAreaOperator. Calling this function replaces any highlight options
         *previously set on this object. \param in_options The highlight options that will be used by this SceneTree. \sa
         *SceneTreeItem::Highlight \sa SceneTreeItem::Unhighlight \sa HighlightOperator \sa HighlightAreaOperator */
        void SetHighlightOptions(HighlightOptionsKit const& in_options);

        /*!	Sets the highlight options that will be used by this SceneTree.  These options are used to perform highlights of
         *elements within the tree and to determine what items within the tree need to be marked as selected when highlights are
         *performed by a HighlightOperator or HighlightAreaOperator. Calling this function replaces any highlight options
         *previously set on this object. All elements of the array should be unique. In the case of multiple identical elements,
         *only the first unique one will be added. \param in_options An array of highlight options that will be used by this
         *SceneTree. \sa SceneTreeItem::Highlight \sa SceneTreeItem::Unhighlight \sa HighlightOperator \sa HighlightAreaOperator
         */
         ...
         *performed by a HighlightOperator or HighlightAreaOperator. Calling this function replaces any highlight options
         *previously set on this object. All elements of the array should be unique. In the case of multiple identical elements,
         *only the first unique one will be added. \param in_count the number of highlight options kits in the in_options array
        ...
        /*!	Appends one highlight options that will be used by this SceneTree.  These options are used to perform highlights of
         *elements within the tree and to determine what items within the tree need to be marked as selected when highlights are
         *performed by a HighlightOperator or HighlightAreaOperator. \param in_options highlight options that will be used by this
         *SceneTree. \sa SceneTreeItem::Highlight \sa SceneTreeItem::Unhighlight \sa HighlightOperator \sa HighlightAreaOperator
         */
        ...
        /*!	Sets the grouping limit for this SceneTree.  The grouping limit determines when to collect certain items into groups
         *of a particular size.  This limit is used to keep the number of children for a particular SceneTreeItem constrained to
         *ensure reasonable performance.  Presently this limit is used for segments and geometry SceneTreeItem objects. \param
        ...
        /*!	Sets the root SceneTreeItem for this SceneTree.  This object should be created on the heap and it should have been
         *created with a SceneTreeItem constructor which took a Model, View, Canvas or Layout, otherwise an exception will be
         *thrown.  Additionally, if there was already an existing root for this SceneTree, the Flush function will be invoked
         *prior to setting this as the new root, and Expand will be invoked on the new root. \param in_root The root SceneTreeItem
         *for this SceneTree. \sa Flush \sa SceneTreeItem::Expand */
        ...
        /*!	Resets the root SceneTreeItem for this SceneTree.  This will release the root SceneTreeItem by this SceneTree and set
         *the root to a null pointer.  If this function is overridden, the overriding function should invoke this base function.
         */
        virtual void Flush();

        /*! Whether the SceneTree should handle highlighting events.
         *  This include expanding the tree to the highlighted SceneTreeItem, and making the text for the highlighted
         * SceneTreeItem bold. By default the SceneTree will handle highlight events.
         ...
         *   This include expanding the tree to the highlighted SceneTreeItem, and making the text for the highlighted
         *SceneTreeItem bold. \return Whether this SceneTreeItem is currently handling highlight events. */
        bool GetHighlightEventHandling() const;

        /*!	Collapses the root SceneTreeItem for this SceneTree and then re-expands the tree.  It will try to preserve the
         *original expansion state, however, if the underlying scene structure has changed, the resulting expansion may look
         *different.*/
        void ReExpand();
    };

    /*! The SceneTreeItem class is a smart pointer which corresponds to an item or node in a tree object in a GUI toolkit, e.g., a
     *TreeViewItem in WPF or an HTREEITEM in MFC. This class must be derived from to facilitate tree creation in the various GUI
     *toolkits.  It is used to represent items in a scene graph or segment browser. */
    class SPRK_API SceneTreeItem: public Sprocket {
      public:
        ...
        /*! The copy constructor creates a SceneTreeItem object that shares the underlying smart-pointer of the source
         *SceneTreeItem. \param in_that The source SceneTreeItem to copy. */
        SceneTreeItem(SceneTreeItem const& in_that);

        /*! The move constructor creates a SceneTreeItem by transferring the underlying object of the rvalue reference to this
         * SceneTreeItem. \param in_that An rvalue reference to a SceneTreeItem to take the underlying object from. */
        SceneTreeItem(SceneTreeItem&& in_that);

        /*! This constructor creates a SceneTreeItem suitable for acting as a root in a SceneTree.  This root would start at the
         *Model.  The Model provided to this constructor should be accessible from the Canvas associated with the SceneTree,
         *otherwise an exception will be thrown. \param in_tree The SceneTree with which to associate this new root SceneTreeItem.
        ...
        /*! This constructor creates a SceneTreeItem suitable for acting as a root in a SceneTree.  This root would start at the
         *View.  The View provided to this constructor should be accessible from the Canvas associated with the SceneTree,
         *otherwise an exception will be thrown. \param in_tree The SceneTree with which to associate this new root SceneTreeItem.
        ...
        /*! This constructor creates a SceneTreeItem suitable for acting as a root in a SceneTree.  This root would start at the
         *Layout.  The Layout provided to this constructor should be accessible from the Canvas associated with the SceneTree,
         *otherwise an exception will be thrown. \param in_tree The SceneTree with which to associate this new root SceneTreeItem.
        ...
        /*! This constructor creates a SceneTreeItem suitable for acting as a root in a SceneTree.  This root would start at the
         *Canvas.  The Canvas provided to this constructor should be the same as the Canvas associated with the SceneTree,
         *otherwise an exception will be thrown. \param in_tree The SceneTree with which to associate this new root SceneTreeItem.
         *	\param in_canvas The Canvas for this root SceneTreeItem.
         *	\sa SceneTree::SetRoot */
        SceneTreeItem(SceneTreePtr const& in_tree, Canvas const& in_canvas);

        /*! This constructor creates a SceneTreeItem which is not suitable for acting as a root in a SceneTree, but is suitable to
         *be a SceneTreeItem under the root of the SceneTree. This constructor should be the one invoked in the overridden
         *AddChild function. \param in_tree The SceneTree with which to associate this new SceneTreeItem. \param in_key The Key
         *for this SceneTreeItem.  This value should come from the corresponding argument to AddChild. \param in_type The type of
         *this SceneTreeItem.  This value should come from the corresponding argument to AddChild. \param in_title The title for
         *this SceneTreeItem.  This value should come from the corresponding argument to AddChild. \sa AddChild */
        SceneTreeItem(SceneTreePtr const& in_tree,
                      Key const& in_key,
        ...
        /*!	Gets the SceneTree associated with this SceneTreeItem.  This provides a means of accessing the derived SceneTree by
         *this SceneTreeItem if necessary. \return The SceneTree associated with this SceneTreeItem. */
        SceneTreePtr GetTree() const;

        /*!	Gets the title for this SceneTreeItem.  This is the text that should be displayed for this SceneTreeItem in the
         *SceneTree. \return The title for this SceneTreeItem. */
        UTF8 GetTitle() const;

        /*!	Gets the item type for this SceneTreeItem.  This is used to determine what type of data this SceneTreeItem represents
         *in the SceneTree. \return The item type for this SceneTreeItem. */
         ...
         *	\return <span class='code'>true</span> if this SceneTreeItem has the given ItemType mask, <span
         *class='code'>false</span> otherwise. */
        ...
        /*!	This function is used to create a new SceneTreeItem to be the child of this SceneTreeItem.  This function will be
         *invoked if this SceneTreeItem has children and Expand has been invoked on it.  This function should contain any
         *necessary calls to GUI toolkits to create the appropriate GUI elements, e.g., see the implementations in the mfc_sandbox
         *or wpf_sandbox.  Additionally, since this function requires the creation of a derived SceneTreeItem, that derived
         *SceneTreeItem should use the base constructor which takes the same arguments this function. \param in_key The Key for
         *this SceneTreeItem.  Should be passed to as the corresponding argument to the base constructor. \param in_type The type
         *for this SceneTreeItem.  Should be passed to as the corresponding argument to the base constructor. \param in_title The
         *title for this SceneTreeItem.  Should be passed to as the corresponding argument to the base constructor. \return A
         *newly created object derived from SceneTreeItem. */
        virtual SceneTreeItemPtr AddChild(Key const& in_key, SceneTree::ItemType in_type, char const* in_title = nullptr) = 0;

        /*!	This function should be invoked when this SceneTreeItem needs to expand.  If this function is overridden, the
         *overriding function should invoke this base function. Additionally, this function will always repopulate the children
         *for this SceneTreeItem when invoked. */
        virtual void Expand();

        /*!	This function should be invoked when this SceneTreeItem needs to collapse.  If this function is overridden, the
         *overriding function should invoke this base function. Additionally, this function will always release all children for
         *this SceneTreeItem when invoked. */
        ...
        /*!	This function will be invoked when this SceneTreeItem should be marked as selected.  Marking an item as selected means
         *that the key backing this SceneTreeItem has been highlighted with the options specified in the associated SceneTree or
         *is along a path in which a highlight has occurred.  This highlighting may have come as a result of the Highlight
         *function on a SceneTreeItem being invoked (not necessarily this SceneTreeItem), or potentially due to the
         *HighlightOperator or HighlightAreaOperator highlighting the key backing this SceneTreeItem or highlighting some path
         *which includes the key backing this SceneTreeItem. This function is meant to be overridden to allow one to change the
         *appearance of a selected SceneTreeItem, e.g., by bolding the text or changing an icon, to signify this new state. If
         *this function is overridden, the overriding function should invoke this base function. */
        virtual void Select();

        /*!	This function will be invoked when this SceneTreeItem should be marked as unselected.  Marking an item as unselected
         *means that the key backing this SceneTreeItem is no longer highlighted with the options specified in the associated
         *SceneTree or is no longer along a path in which a highlight has occurred.  This unhighlighting may have come as a result
         *of the Unhighlight function on a SceneTreeItem being invoked (not necessarily this SceneTreeItem), or potentially due to
         *the HighlightOperator or HighlightAreaOperator unhighlighting the key backing this SceneTreeItem. or unhighlighting some
         *path which includes the key backing this SceneTreeItem. This function is meant to be overridden to allow one to change
         *the appearance of a selected SceneTreeItem,
         *	e.g., by no longer bolding the text or changing an icon, to signify this new state. If this function is overridden,
         *the overriding function should invoke this base function. */
        virtual void Unselect();

        /*! Indicates whether this SceneTreeItem is able to be highlighted.  Some items, like those in static trees, cannot be
         *highlighted. \return Whether this SceneTreeItem is highlightable. \sa Highlight \sa IsHighlighted */
         ...
         *This may mean that the Highlight function on this SceneTreeItem was invoked, or that the key backing this SceneTreeItem
         *was highlighted by the HighlightOperator or HighlightAreaOperator. \return Whether this SceneTreeItem is currently
         *highlighted with the options specified in the associated SceneTree. \sa Highlight \sa Unhighlight */
        bool IsHighlighted() const;

        /*!	This function will cause this SceneTreeItem to be highlighted with the options specified in the associated SceneTree.
         *This will cause elements along the path to this item (and this item itself) to be marked as selected if they aren't
         *already.  Depending on the type of the SceneTreeItem, sometimes a highlight is nonsensical.  In this case, no highlight
         *will be performed. \param in_higlight_options_index The index in the highlight options array held by the associated
         *SceneTree. Defaults to 0. \sa Select */
        void Highlight(size_t in_highlight_options_index = 0);

        /*!	This function will cause this SceneTreeItem to be highlighted with the options specified in the associated SceneTree.
         *This will cause elements along the path to this item (and this item itself) to be marked as selected if they aren't
         *already.  Depending on the type of the SceneTreeItem, sometimes a highlight is nonsensical.  In this case, no highlight
         *will be performed. If the options requested is not part of the associated SceneTree highlight options, it will be added
         *to them. \param in_highlight_options The highlight options used during highlighting \sa Select */
        void Highlight(HighlightOptionsKit const& in_highlight_options);

        /*!	This function will remove the highlight with the options specified in the associated SceneTree from this
         *SceneTreeItem.  This can cause elements along the path to this item (and this item itself) to be marked as unselected
         *unless those items lie along a path which is still highlighted.  Depending on the type of the SceneTreeItem, sometimes
         *an unhighlight is nonsensical. In this case, no unhighlight will be performed. \param in_higlight_options_index The
         *index in the highlight options array held by the associated SceneTree. Defaults to 0. \sa Unselect */
        void Unhighlight(size_t in_highlight_options_index = 0);

        /*!	This function will remove the highlight with the options specified in the associated SceneTree from this
         *SceneTreeItem.  This can cause elements along the path to this item (and this item itself) to be marked as unselected
         *unless those items lie along a path which is still highlighted.  Depending on the type of the SceneTreeItem, sometimes
         *an unhighlight is nonsensical. In this case, no unhighlight will be performed. If the options requested is not part of
         *the associated SceneTree highlight options, it will be added to them. \param in_higlight_options_index The index in the
         *highlight options array held by the associated SceneTree. Defaults to 0. \sa Unselect */
        ...
        /*!	Collapses this SceneTreeItem and then re-expands the tree.  It will try to preserve the original expansion state,
         *however, if the underlying scene structure has changed, the resulting expansion may look different. */
        void ReExpand();
    };
    ...
    /*! The ComponentTree class is a smart pointer which corresponds to a tree object in a GUI toolkit, e.g., a TreeView in WPF or
     *a CTreeCtrl in MFC. This class can be derived from to facilitate tree creation in the various GUI toolkits.  It is used to
     *create a component or model browser. */
    class SPRK_API ComponentTree: public Sprocket {
      public:
        ...
        /*! This constructor creates a ComponentTree object associated with a Canvas and a layer.  This constructor should be used
         *to create a new ComponentTree object. \param in_canvas The Canvas to associate this ComponentTree with.
        ...
        /*! The copy constructor creates a ComponentTree object that shares the underlying smart-pointer of the source
         *ComponentTree. \param in_that The source ComponentTree to copy. */
        ComponentTree(ComponentTree const& in_that);

        /*! The move constructor creates a ComponentTree by transferring the underlying object of the rvalue reference to this
         * ComponentTree. \param in_that An rvalue reference to a ComponentTree to take the underlying object from. */
        ...
        /*!	Sets the highlight options that will be used by this ComponentTree.  These options are used to perform highlights of
         *elements within the tree and to determine what items within the tree need to be marked as highlighted when highlights
         *are performed by ComponentPath::Highlight. Calling this function replaces any highlight options previously set on this
         *object. \param in_options The highlight options that will be used by this ComponentTree. \sa
         *ComponentTreeItem::Highlight \sa ComponentTreeItem::Unhighlight \sa ComponentPath::Highlight \sa
         ...
         *elements within the tree and to determine what items within the tree need to be marked as highlighted when highlights
         *are performed by ComponentPath::Highlight. Calling this function replaces any highlight options previously set on this
         *object. All elements of the array should be unique. In the case of multiple identical elements, only the first unique
         *one will be added. \param in_options An array of highlight options that will be used by this ComponentTree. \sa
         *ComponentTreeItem::Highlight \sa ComponentTreeItem::Unhighlight \sa ComponentPath::Highlight \sa
         *ComponentPath::Unhighlight */
        void SetHighlightOptions(HighlightOptionsKitArray const& in_options);
         ...
         *are performed by ComponentPath::Highlight. Calling this function replaces any highlight options previously set on this
         *object. All elements of the array should be unique. In the case of multiple identical elements, only the first unique
         *one will be added. \param in_count the number of highlight options kits in the in_options array \param in_options An
         *array of highlight options that will be used by this ComponentTree. \sa ComponentTreeItem::Highlight \sa
         *ComponentTreeItem::Unhighlight \sa ComponentPath::Highlight \sa ComponentPath::Unhighlight */
        void SetHighlightOptions(size_t in_count, HighlightOptionsKit const in_options[]);
         ...
         *	determine what items within the tree need to be marked as highlighted when highlights are performed by
         *ComponentPath::Highlight. If the options kit requested is already part of the ComponentTree highlight options array, it
         *will not be added to it. \param in_options The highlight options that will be used by this ComponentTree. \sa
         *ComponentTreeItem::Highlight \sa ComponentTreeItem::Unhighlight \sa ComponentPath::Highlight \sa
         *ComponentPath::Unhighlight */
        void AddHighlightOptions(HighlightOptionsKit const& in_options);
        ...
        /*!	Sets the root ComponentTreeItem for this ComponentTree.  This object should be created on the heap and it should have
         *been created with a ComponentTreeItem constructor which took a CADModel, otherwise an exception will be thrown.
         *Additionally, if there was already an existing root for this ComponentTree, the Flush function will be invoked prior to
         *setting this as the new root, and Expand will be invoked on the new root. \param in_root The root ComponentTreeItem for
         *this ComponentTree. \sa Flush \sa ComponentTreeItem::Expand */
        ...
        /*!	Resets the root ComponentTreeItem for this ComponentTree.  This will release the root ComponentTreeItem by this
         *ComponentTree and set the root to a null pointer.  If this function
         *	is overridden, the overriding function should invoke this base function. */
        virtual void Flush();

        /*!	Collapses the root ComponentTreeItem for this ComponentTree and then re-expands the tree.  It will try to preserve the
         *original expansion state, however, if the underlying component structure has changed, the resulting expansion may look
         *different.*/
        void ReExpand();

        /*! Whether the ComponentTree should handle highlighting events.
         *  This include expanding the tree to the highlighted components, and making the text for the highlighted component tree
         * items bold. By default the ComponentTree will handle highlight events. \param in_state Whether to handle highlight
         * events.*/
        void SetHighlightEventHandling(bool in_state);

        /*! Whether this ComponentTree is currently handling highlight events
         *   This include expanding the tree to the highlighted components, and making the text for the highlighted component tree
         *items bold. \return Whether this ComponentTree is currently handling highlight events. */
        bool GetHighlightEventHandling() const;
    };

    /*! The ComponentTreeItem class is a smart pointer which corresponds to an item or node in a tree object in a GUI toolkit,
     *e.g., a TreeViewItem in WPF or an HTREEITEM in MFC. This class must be derived from to facilitate tree creation in the
     *various GUI toolkits.  It is used to represent items in a component or model browser. */
    class SPRK_API ComponentTreeItem: public Sprocket {
      public:
        /*! The default constructor creates an uninitialized ComponentTreeItem object.  The Type() function will return
         * Type::None. */
        ComponentTreeItem();

        /*! The copy constructor creates a ComponentTreeItem object that shares the underlying smart-pointer of the source
         *ComponentTreeItem. \param in_that The source ComponentTreeItem to copy. */
        ComponentTreeItem(ComponentTreeItem const& in_that);

        /*! The move constructor creates a ComponentTreeItem by transferring the underlying object of the rvalue reference to this
         * ComponentTreeItem. \param in_that An rvalue reference to a ComponentTreeItem to take the underlying object from. */
        ComponentTreeItem(ComponentTreeItem&& in_that);

        /*! This constructor creates a ComponentTreeItem suitable for acting as a root in a ComponentTree.  The CADModel provided
         *to this constructor should be accessible from the Canvas and layer associated with the ComponentTree, otherwise an
         *exception will be thrown. \param in_tree The ComponentTree with which to associate this new root ComponentTreeItem.
        ...
        /*! This constructor creates a ComponentTreeItem which is not suitable for acting as a root in a ComponentTree, but is
         *suitable to be a ComponentTreeItem under the root of the ComponentTree. This constructor should be the one invoked in
         *the overridden AddChild function. \param in_tree The ComponentTree with which to associate this new ComponentTreeItem.
         *	\param in_component The Component for this ComponentTreeItem.  This value should come from the corresponding argument
         *to AddChild. \param in_type The type of this ComponentTreeItem.  This value should come from the corresponding argument
         *to AddChild. \sa AddChild */
        ...
        /*!	Gets the ComponentTree associated with this ComponentTreeItem.  This provides a means of accessing the derived
         *ComponentTree by this ComponentTreeItem if necessary.
         *	\return The ComponentTree associated with this ComponentTreeItem. */
        ComponentTreePtr GetTree() const;

        /*!	Gets the title for this ComponentTreeItem.  This is the text that should be displayed for this ComponentTreeItem in
         *the ComponentTree. \return The title for this ComponentTreeItem. */
        UTF8 GetTitle() const;

        /*!	Gets the item type for this ComponentTreeItem.  This is used to determine what type of data this ComponentTreeItem
         *represents in the ComponentTree. \return The item type for this ComponentTreeItem. */
        ComponentTree::ItemType GetItemType() const;

        /*!	Gets the Component for this ComponentTreeItem.  The type of the Component depends on the ComponentTree::ItemType for
         *this ComponentTreeItem. \return The Component for this ComponentTreeItem. */
        ...
        /*!	This function is used to create a new ComponentTreeItem to be the child of this ComponentTreeItem.  This function will
         *be invoked if this ComponentTreeItem has children and Expand has been invoked on it.  This function should contain any
         *necessary calls to GUI toolkits to create the appropriate GUI elements. Additionally, since this function requires the
         *creation of a derived ComponentTreeItem, that derived ComponentTreeItem should use the base constructor which takes the
         *same arguments this function. \param in_component The Component for this ComponentTreeItem.  Should be passed to as the
         *corresponding argument to the base constructor. \param in_type The type for this ComponentTreeItem.  Should be passed to
         *as the corresponding argument to the base constructor. \return A newly created object derived from ComponentTreeItem. */
        virtual ComponentTreeItemPtr AddChild(Component const& in_component, ComponentTree::ItemType in_type) = 0;

        /*!	This function should be invoked when this ComponentTreeItem needs to expand.  If this function is overridden, the
         *overriding function should invoke this base function. Additionally, this function will always repopulate the children
         *for this ComponentTreeItem when invoked. */
        virtual void Expand();

        /*!	This function should be invoked when this ComponentTreeItem needs to collapse.  If this function is overridden, the
         *overriding function should invoke this base function. Additionally, this function will always release all children for
         *this ComponentTreeItem when invoked. */
        virtual void Collapse();

        /*! Indicates whether this ComponentTreeItem is currently highlighted with the options specified in the associated
         *ComponentTree.  This may mean that the Highlight function on this ComponentTreeItem was invoked, or that the Component
         *backing this ComponentTreeItem was highlighted by ComponentPath::Highlight. \note The state of this ComponentTreeItem
         *may not yet mirror the state of the underlying ComponentPath as the notification is asynchronous. In order for this
         *ComponentTreeItem to mirror the state of the underlying ComponentPath, a synchronous update needs to be performed on the
         *associated view. \return Whether this ComponentTreeItem is currently highlighted with the options specified in the
         *associated ComponentTree. \sa Highlight \sa Unhighlight */
        bool IsHighlighted() const;

        /*!	This function will be invoked when this ComponentTreeItem should be marked as highlighted. This highlighting may have
         *come as a result of the Highlight function on a ComponentTreeItem being invoked, or due to ComponentPath::Highlight
         *being invoked on the Component backing this ComponentTreeItem. This function is meant to be overridden to allow one to
         *change the appearance of a highlighted ComponentTreeItem, e.g., by bolding the text or changing an icon, to signify this
         *new state. If this function is overridden, the overriding function should invoke this base function. \param in_options
         *The HighlightOptionsKit for the associated highlight. */
        virtual void OnHighlight(HighlightOptionsKit const& in_options);

        /*!	This function will be invoked when this ComponentTreeItem should be marked as unhighlighted. This unhighlighting may
         *have come as a result of the Unhighlight function on a ComponentTreeItem being invoked, or due to
         *ComponentPath::Unhighlight being invoked on the Component backing this ComponentTreeItem. This function is meant to be
         *overridden to allow one to change the appearance of a unhighlighted ComponentTreeItem, e.g., by no longer bolding the
         *text or changing an icon, to signify this new state. If this function is overridden, the overriding function should
         *invoke this base function. \param in_options The HighlightOptionsKit for the associated unhighlight. */
        virtual void OnUnhighlight(HighlightOptionsKit const& in_options);

        /*!	This function will cause this ComponentTreeItem to be highlighted with the nth option specified in the associated
         *ComponentTree.  This will cause this item to be marked as highlighted if it isn't already.  Depending on the type of the
         *ComponentTreeItem, sometimes a highlight is nonsensical.  In this case, no highlight will be performed. \param
         ...
         *  If the options requested is not part of the associated ComponentTree highlight options, it will be added to them. This
         *will cause this item to be marked as highlighted if it isn't already.  Depending on the type of the ComponentTreeItem,
         *sometimes a highlight is nonsensical.  In this case, no highlight will be performed. \param in_highlight_options The
         *highlight options used during highlighting \sa OnHighlight */
        void Highlight(HighlightOptionsKit const& in_highlight_options);

        /*!	This function will cause this ComponentTreeItem to be unhighlighted with the nth option specified in the associated
         *ComponentTree.  This will cause this item to be marked as unhighlighted if it isn't already.  Depending on the type of
         *the ComponentTreeItem, sometimes an unhighlight is nonsensical.  In this case, no unhighlight will be performed. \param
         *in_higlight_options_index The index in the highlight options array held by the associated ComponentTree. Defaults to 0.
         *	\sa OnUnhighlight */
        void Unhighlight(size_t in_highlight_options_index = 0);
         ...
         *  If the options requested is not part of the associated ComponentTree highlight options, it will be added to them. This
         *will cause this item to be marked as unhighlighted if it isn't already.  Depending on the type of the ComponentTreeItem,
         *sometimes a highlight is nonsensical.  In this case, no unhighlight will be performed. \param in_highlight_options The
         *highlight options used during unhighlighting \sa OnUnhighlight */
        void Unhighlight(HighlightOptionsKit const& in_highlight_options);

        /*! Indicates whether this ComponentTreeItem is currently hidden.  This may mean that the Hide function on this
         *ComponentTreeItem was invoked, or that the Component backing this ComponentTreeItem was hidden via ComponentPath::Hide
         *or ComponentPath::Isolate. \note The state of this ComponentTreeItem may not yet mirror the state of the underlying
         *ComponentPath as the notification is asynchronous. In order for this ComponentTreeItem to mirror the state of the
         *underlying ComponentPath, a synchronous update needs to be performed on the associated view. \return Whether this
         *ComponentTreeItem is currently hidden. \sa Hide \sa Show \sa Isolate \sa ResetVisibility \sa ComponentPath::Hide \sa
         *ComponentPath::Show \sa ComponentPath::Isolate \sa ComponentPath::ResetVisibility \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        bool IsHidden() const;

        /*!	This function will be invoked when this ComponentTreeItem should be marked as hidden. This hiding may have come as a
         *result of the Hide or Isolate function on a ComponentTreeItem being invoked, or due to ComponentPath::Hide being invoked
         *on the Component backing this ComponentTreeItem. This function is meant to be overridden to allow one to change the
         *appearance of a hidden ComponentTreeItem, e.g., by graying the text or changing an icon, to signify this new state. If
         *this function is overridden, the overriding function should invoke this base function. \sa Hide
         */
        virtual void OnHide();

        /*!	This function will be invoked when this ComponentTreeItem should be marked as visible. This visibility may have come
         *as a result of the Show or Isolate function on a ComponentTreeItem being invoked, or due to ComponentPath::Show or
         *ComponentPath::Isolate being invoked on the Component backing this ComponentTreeItem. This function is meant to be
         *overridden to allow one to change the appearance of a visible ComponentTreeItem, e.g., by no longer graying out the text
         *or changing an icon, to signify this new state. If this function is overridden, the overriding function should invoke
         *this base function. \sa Show
         */
        virtual void OnShow();

        /*!	This function will cause this ComponentTreeItem to be hidden if it isn't already.  This will cause this item to be
         *marked as hidden if it isn't already.  Depending on the type of the ComponentTreeItem, sometimes a hide is nonsensical.
         *In this case, no hide will be performed. If activated, this forces the visibility of the associated ComponentPath and
         *all components under this path to invisible. Any visibility changes made previously at or below this path are flushed.
         *	When performing a highlight in combination with this function the highlight must be applied with
         *Drawing::Overlay::InPlace to display properly. See <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this section</a> for limitations and
         *details on managing component visibility. \sa OnHide \sa Show \sa Isolate \sa ResetVisibility \sa IsHidden \sa
         *ComponentPath::Hide \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        void Hide();

        /*!	This function will cause this ComponentTreeItem to be visible if it isn't already.  Depending on the type of the
         *ComponentTreeItem, sometimes a show is nonsensical.  In this case, no show will be performed. If activated, this makes
         *the selected path visibile but preserves the model-defined visibility of any components that exist underneath the
         *associated ComponentPath. Any visibility changes made subsequently at or below this path are honored unless they are
         *redundant. When performing a highlight in combination with this function the highlight must be applied with
         *Drawing::Overlay::InPlace to display properly. See <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this section</a> for limitations and
         *details on managing component visibility. \sa OnShow \sa Hide \sa Isolate \sa ResetVisibility \sa IsHidden \sa
         *ComponentPath::Show \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        void Show();

        /*!	This function will cause this ComponentTreeItem to be isolated, i.e., all other items will be hidden and this item
         *will be shown.  This will cause this item to be marked as visible if it isn't already, and all other items to be marked
         *as hidden. Depending on the type of the ComponentTreeItem, sometimes an isolate is nonsensical.  In this case, no
         *isolate will be performed. When performing a highlight in combination with this function the highlight must be applied
         *with Drawing::Overlay::InPlace to display properly. See <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this section</a> for limitations and
         *details on managing component visibility. \sa OnHide \sa OnShow \sa Show \sa Hide \sa ResetVisibility \sa IsHidden \sa
         *ComponentPath::Isolate \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        void Isolate();

        /*!	This function will cause the visibility of this ComponentTreeItem to be reset to what is dictated by the associated
         *CADModel & View. See <a href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">this
         *section</a> for limitations and details on managing component visibility. \sa Hide \sa Show \sa Isolate \sa IsHidden \sa
         *ComponentPath::ResetVisibility \sa Programming Guide: <a
         *href="../../prog_guide/0904_component_hierarchy.html#managing_component_visibility">Managing Component Visibility</a>
         */
        ...
        /*!	Collapses this ComponentTreeItem and then re-expands the tree.  It will try to preserve the original expansion state,
         *however, if the underlying component structure has changed, the resulting expansion may look different. */
        void ReExpand();
    };

    /*! The AnimationControl class is a smart pointer that is tied to a database object.
     *	This control allows you to conduct playback for animations on the associated view. */
    class SPRK_API AnimationControl: public SprocketControl {
      public:
        /*! Initializes a control tied to the view in_view. */
        ...
        /*! The move constructor creates a AnimationControl by transferring the underlying impl of the rvalue reference to this
         * AnimationControl thereby avoiding a copy and allocation. \param in_that An rvalue reference to a AnimationControl to
         * take the impl from.*/
        AnimationControl(AnimationControl&& in_that);

        /*! The move assignment operator transfers the underlying impl of the rvalue reference to this OperatorControl thereby
         * avoiding a copy. \param in_that An rvalue reference to a AnimationControl to take the impl from.
         ...
         *	\warning If animation playback is already occuring this will throw an InvalidOperationException.
         *	\param in_duration The duration in milliseconds.*/
        ...
        /*!	Asynchronously starts playback of the attached animation(s) executing from in_start_tick up to in_end_tick.
         *	If in_end_tick is lesser than in_start_tick playback will occur in reverse.
         *	Any playback currently stopped on this AnimationControl cannot be resumed after this call.
         *	\warning If SetAnimations hasn't been called on this AnimationControl this function will throw an
         *InvalidOperationException. \warning If animation playback is already occuring this will throw an
         *InvalidOperationException. \param in_start_tick The tick to start playback from. \param in_end_tick The tick to stop
         *playback at.*/
        void Play(uint32_t in_start_tick, uint32_t in_end_tick);

        /*!	Starts playback of the attached animation(s) executing from tick 0 up to the last tick specified by the attached
         *animation(s). Any playback currently stopped on this AnimationControl cannot be resumed after this call. \warning If
         *SetAnimations hasn't been called on this AnimationControl this function will throw an InvalidOperationException.
         *	\warning If animation playback is already occuring this will throw an InvalidOperationException.
         */
        void Play();
        ...
        /*!	Sets the animation to apply during playback on the view associated with this AnimationControl.
         *	This will override any previous animation(s) set on this AnimationControl.
         *	\warning If animation playback is already occuring this will throw an InvalidOperationException
         *	\param in_animation The animation to use for playback.*/
        void SetAnimation(Animation const& in_animation);

        /*!	Sets the animations to apply during playback on the view associated with this AnimationControl.
         *  Playback of multiple animations will occur simultaneously.
         *	This will override any previous animation(s) set on this AnimationControl.
         *	\warning If animation playback is already occuring this will throw an InvalidOperationException.
         *	\param in_count The number of animations that will be associated with this AnimationControl.
         *	\param in_animations The animations to use for playback.*/
         ...
         *	\param out_animations The animations that are currently set on this animation control.*/
